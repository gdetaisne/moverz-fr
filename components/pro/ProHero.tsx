        ...
        <div className="mt-12 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            >
              ...
              <span>Solution SaaS pour déménageurs</span>
            </motion.div>
            ...
            >
              Vos clients calculent<br />leur volume en
              <span className="text-[#6BCFCF]"> 1 minute</span>
            </motion.h1>
            ...
            >
              Widget IA en marque blanche qui s'intègre sur votre site en 5 minutes. 
              Photos → Volume → Devis. Simple, précis, 100% automatique.
            </motion.p>
            ...
            >
              ...
              >
                <span>Tester 30 jours gratuit</span>
