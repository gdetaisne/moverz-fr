...
import { LayoutList, Shield, Filter } from "lucide-react";

export default function PartenairesWhatClientReceives() {
  const items = [
    {
      icon: LayoutList,
      text: "Une comparaison lisible des 3 à 5 offres"
    },
    {
      icon: Shield,
      text: "Des repères pour décider sereinement : prestations, garanties, avis, sérieux perçu"
    },
    {
      icon: Filter,
      text: "Une sélection « encadrée » : le client ne part pas dans tous les sens"
    }
  ];
