...
import { UserCheck, Phone, FileEdit, Calendar } from "lucide-react";

export default function PartenairesIfChosen() {
  const steps = [
    { icon: Phone, text: "appel / visio / visite technique" },
    { icon: FileEdit, text: "ajustements du devis si nécessaire" },
    { icon: Calendar, text: "confirmation et organisation du déménagement" }
  ];
