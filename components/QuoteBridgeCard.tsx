  ...
  return (
    <div className="rounded-3xl bg-white border border-[#E6EEF2] shadow-[0_14px_50px_rgba(15,23,42,0.06)] p-6 md:p-7 space-y-5">
      ...
      <div className="space-y-2">
        <div className="inline-flex items-center gap-2 rounded-full bg-brand-turquoise/10 border border-brand-turquoise/25 px-3 py-1 text-xs font-semibold text-[#0F172A] w-fit">
      ...
      <div className="space-y-3">
        ...
        >
          <div className="flex items-start justify-between gap-3">
            ...
            <span className="rounded-full bg-brand-turquoise/12 border border-brand-turquoise/25 px-2.5 py-1 text-[11px] font-bold text-[#0F172A]">
              Recommandé
            </span>
          </div>
