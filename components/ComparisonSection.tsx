...
export default function ComparisonSection() {
  const benefits = [
    ...
    },
    {
      ...
      title: "Gain de temps",
      description: "Un seul dossier, des devis reçus sans relances ni visites techniques.",
    },
    {
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="relative grid gap-6 md:grid-cols-2 lg:gap-8">
        ...
        <div
          ...
          >
            ...
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-brand-turquoise/0 to-[var(--color-accent)]/0 opacity-0 transition-opacity duration-500 group-hover:opacity-10" />
            
            <div className="relative flex items-start gap-4">
              {/* Pictogramme SVG avec animation */}
              <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-turquoise/20 to-[var(--color-accent)]/30 border border-[var(--color-accent)]/30 text-[var(--color-accent)] transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 group-hover:shadow-[0_0_20px_rgba(107,207,207,0.4)]">
                {benefit.icon}
          </div>
