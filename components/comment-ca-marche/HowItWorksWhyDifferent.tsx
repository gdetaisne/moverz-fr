    ...
    <section className="py-20 md:py-28 bg-gradient-to-b from-white to-[#F8F9FA]">
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-base md:text-lg text-[var(--color-text-secondary)]/70 max-w-3xl mx-auto">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {/* Classic */}
          <div className="relative overflow-hidden rounded-3xl border border-[var(--color-border)] bg-white p-7 md:p-8 shadow-sm">
            <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-transparent to-gray-50" />
            <div className="relative space-y-5">
              <div className="flex items-center justify-between gap-4">
                <div className="space-y-1">
                  <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[var(--color-text-secondary)]">Plateformes classiques</p>
                  <p className="text-lg font-bold text-[var(--color-text)]">Rapide… mais flou</p>
                </div>
              ...
              <ol className="space-y-3">
                {classic.map((line, i) => (
                  <li key={line} className="flex items-start gap-3 text-sm text-[var(--color-text-secondary)]/75">
                    <span className="mt-0.5 inline-flex h-6 w-6 items-center justify-center rounded-full bg-gray-100 text-[var(--color-text)] text-xs font-bold">
                      {i + 1}
                    </span>
                    <span>{line}</span>
                  </li>
            ...
            <div className="relative space-y-5">
              <div className="flex items-center justify-between gap-4">
                <div className="space-y-1">
                  ...
                  <p className="text-lg font-bold text-[var(--color-text)]">Plus précis, plus serein</p>
                </div>
              ...
              <ol className="space-y-3">
                {moverz.map((line, i) => (
                  <li key={line} className="flex items-start gap-3 text-sm text-[var(--color-text-secondary)]/75">
                    <span className="mt-0.5 inline-flex h-6 w-6 items-center justify-center rounded-full bg-brand-turquoise/12 text-[var(--color-text)] text-xs font-bold border border-brand-turquoise/20">
                      {i + 1}
                    </span>
                    <span>{line}</span>
                  </li>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-sm font-semibold text-[var(--color-text)] hover:text-[#2B7A78] transition-colors"
              >
