        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          <div className="lg:col-span-5 space-y-5">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href="/villes/"
                className="inline-flex items-center gap-2 rounded-full border border-[var(--color-border)] bg-white px-5 py-3 text-sm font-semibold text-[var(--color-text)] hover:border-brand-turquoise/50 hover:bg-[var(--color-bg)] transition-colors"
              >
            ...
            {items.map((it) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-sm text-[var(--color-text-secondary)]/70 leading-relaxed">{it.desc}</p>
                </div>
              );
            })}
          </div>
