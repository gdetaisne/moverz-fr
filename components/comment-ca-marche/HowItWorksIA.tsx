  ...
  return (
    <section className="py-20 md:py-28 bg-white">
      <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-[var(--color-border)] bg-[#F9FAFB] p-8 md:p-10">
          <div className="max-w-3xl space-y-4">
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-[var(--color-text)] leading-tight">
              Un dossier clair, pour des devis comparables
            </h2>
            <p className="text-base md:text-lg text-[var(--color-text-secondary)]/70 leading-relaxed">
            ...
            <ul className="text-sm md:text-base text-[var(--color-text-secondary)]/80 space-y-2">
