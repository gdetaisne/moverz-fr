        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-[1.1]">
              Pourquoi choisir{" "}
              <span className="bg-gradient-to-r from-cyan-400 via-cyan-500 to-blue-500 bg-clip-text text-transparent">Moverz</span> ?
            </h1>

            <p className="text-xl text-white/90 mb-10 leading-relaxed font-normal">
              Moverz ne compare pas seulement des devis.{" "}
              <strong className="text-white font-bold">Moverz compare des entreprises, leur fiabilité et le risque associé.</strong>
            </p>
