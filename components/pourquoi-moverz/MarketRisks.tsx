            ...
            <div className="relative w-full max-w-[420px] mx-auto">
              <div className="bg-white rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.15)] p-6 border border-[var(--color-border)]">
                ...
                <div className="flex items-center justify-between mb-6 pb-4 border-b border-[var(--color-border)]">
                  <div>
                    <p className="text-xs text-[var(--color-text-secondary)]/60 font-medium">Secteur déménagement</p>
                    <p className="text-lg font-bold text-[var(--color-text)]">Analyse des risques</p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-xl bg-red-50 border border-red-200">
                    ...
                    <p className="text-xs text-[var(--color-text-secondary)]/50 mt-2">Source : DGCCRF 2023</p>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-orange-50 border border-orange-200">
                    ...
                    <p className="text-xs text-[var(--color-text-secondary)]/50 mt-2">Source : CSD 2024</p>
                  </div>

                  {/* Stat 3 */}
                  <div className="p-4 rounded-xl bg-gray-50 border border-[var(--color-border)]">
                    <div className="flex items-center justify-between mb-2">
                    ...
                    <p className="text-xs text-[var(--color-text-secondary)]/50 mt-2">Source : Étude marché</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-6 mb-10">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-[var(--color-text)] mb-1">64% d'anomalies détectées</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-[var(--color-text)] mb-1">257 faillites en 2024</h3>
                  <p className="text-[var(--color-text-secondary)]/70 text-sm">
              ...
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 flex items-center justify-center w-10 h-10 rounded-full bg-gray-100">
                  <Building2 className="w-5 h-5 text-[var(--color-text-secondary)]" strokeWidth={2.5} />
                </div>
                <div>
                  <h3 className="font-bold text-[var(--color-text)] mb-1">90% de petites structures</h3>
                  <p className="text-[var(--color-text-secondary)]/70 text-sm">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-brand-turquoise/10 to-[#A8E8E8]/10 border border-brand-turquoise/30">
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="font-bold text-[var(--color-text)]">Moverz vous protège</p>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                <span className="text-xs font-medium text-[var(--color-text)] bg-white px-3 py-1 rounded-full">✓ Historique litiges</span>
                <span className="text-xs font-medium text-[var(--color-text)] bg-white px-3 py-1 rounded-full">✓ Situation financière</span>
                <span className="text-xs font-medium text-[var(--color-text)] bg-white px-3 py-1 rounded-full">✓ Évolution</span>
              </div>
            </div>
          </div>
        </div>
