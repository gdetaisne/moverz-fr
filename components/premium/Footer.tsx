            ...
            <div className="space-y-5">
              ...
              <form action="/search" method="get" className="flex gap-2">
                ...
                <input
                  ...
                  className="flex-1 rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white placeholder:text-white/50 backdrop-blur-sm focus:border-white/20 focus:outline-none focus:ring-1 focus:ring-white/20 transition-all"
                />
                <button
                  type="submit"
                  className="shrink-0 rounded-lg bg-white/10 p-2.5 text-white backdrop-blur-sm transition-all hover:bg-white/15"
