...
/**
 * Generate metadata for hardcoded city service pages.
 * Global title.template already appends "| Moverz" (see app/layout.tsx).
 * We normalize any legacy titles that still include the suffix to avoid duplication.
 */
      ...
      <section className="relative overflow-hidden text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-24">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <h1 className="text-4xl font-bold tracking-tight leading-[1.15] sm:text-5xl md:text-6xl font-heading">
              {h1}
            </h1>
              ...
              <div className="pt-4">
                ...
                >
                  ...
                  <span className="underline underline-offset-4">
                    Prix d&apos;un déménagement à {cityName}
                  </span>
                  <span>→</span>
                </a>
              </div>
      ...
      <section className="py-12 md:py-20 bg-gradient-to-br from-[#fdfeff] via-[#f9fdff] to-[#f5fbfc]">
        <div className="container mx-auto max-w-5xl px-4 space-y-8">
          ...
          <div className="rounded-2xl border border-[var(--color-border)] bg-white p-6 md:p-8 space-y-4">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-[var(--color-text-secondary)]">
                Quelques précisions suffisent pour fiabiliser le devis (et
          ...
          {sections.map((s) => (
            <div
              key={s.title}
              className="rounded-2xl border border-[var(--color-border)] bg-white p-6 md:p-8 space-y-4"
            >
              <h2 className="text-xl md:text-2xl font-bold text-[var(--color-text)]">
                {s.title}
              </h2>
          ...
          {/* Long tail internal links */}
          <LongTailInternalLinks
            cityName={cityName}
