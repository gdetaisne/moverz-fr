 ...
 * 
 * Format title: "Déménagement {Ville A} → {Ville B} ({Distance}km) · 3–5 devis, pros contrôlés Pappers"
 * Format desc: "✓ 1 contact ✓ 0 harcèlement · {A}→{B} ({X}km) : T1 X€, T2 Y€, Maison Z€ · Pros contrôlés Pappers · Gratuit"
 */
/**
...
const CORRIDOR_META_OVERRIDES: Record<string, { title: string; description: string }> = {
  "paris-vers-marseille": {
    ...
    description: "Paris–Marseille 830 km, 2 jours. T1 1 510–2 260€, T2 1 890–2 840€, Maison 3 010–4 520€. A6/A7, péages ~120€. Pros contrôlés Pappers, 3–5 devis comparables.",
  },
  "paris-vers-nice": {
  ...
  "paris-vers-toulouse": {
    ...
    description: "Paris–Toulouse 740 km, A10/A20, péages ~100€. T1 1 420–2 130€, T2 1 810–2 710€. 3–5 devis comparables, pros contrôlés Pappers.",
  },
  "marseille-vers-lyon": {
  ...
  "paris-vers-lyon": {
    ...
    description: "Paris–Lyon 490 km, A6, 4h. T1 1 010–1 520€, T2 1 310–1 960€, Maison 2 160–3 240€. Corridor le plus fréquent — 3–5 devis, pros contrôlés Pappers.",
  },
  "paris-vers-rennes": {
  ...
  "lyon-vers-paris": {
    ...
    description: "Lyon–Paris 490 km, A6, 4h. T1 1 010–1 520€, T2 1 310–1 960€. Corridor majeur — 3–5 devis, pros contrôlés Pappers.",
  },
...
export function generateCorridorMetadata(
  ...
  if (priceData) {
    ...
    const title = `Déménagement ${originCityName} → ${destination} (${priceData.distanceKm}km) · 3–5 devis, pros Pappers`;

    // Description alignée villes v3.1 : checkmarks ✓ + USP stack + prix + social proof
    const description = `${originCityName}→${destination} (${priceData.distanceKm}km) : T1 ${priceData.t1}, T2 ${priceData.t2}, Maison ${priceData.house}. 3–5 devis comparables, pros contrôlés Pappers. Gratuit.`;
  ...
  const description = `${originCityName}→${destination} : 3–5 devis gratuits, pros contrôlés Pappers. Sans démarchage.`;
