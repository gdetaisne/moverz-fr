 ...
 * 
 * Format title: "Déménagement {Quartier} ({Ville}) · 3–5 devis, pros contrôlés Pappers"
 * Format desc: "{Quartier}, {Ville} : 3–5 devis comparables, pros contrôlés Pappers. Dossier anonyme, 0€."
 */
export function generateQuartierMetadata(
  ...
  const title = `Déménagement ${quartierName} (${cityName}) · 3–5 devis, pros Pappers`;
  const description = `${quartierName}, ${cityName} : 3–5 devis comparables, pros contrôlés Pappers. Dossier anonyme, 0€.`;
