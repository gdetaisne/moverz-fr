        ...
        >
          <div className={`flex items-center justify-center w-8 h-8 rounded-full transition-all duration-300 ${
            isOpen
              ...
              : "bg-[var(--color-border-light)] text-[var(--color-text-muted)] group-hover:bg-[var(--color-accent)]/10 group-hover:text-[var(--color-accent)]"
          }`}>
      ...
      <div className="container max-w-3xl">
        <div className="text-center mb-12 space-y-4">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-brand-turquoise/10 to-[var(--color-accent)]/10 border border-[var(--color-accent)]/20 px-4 py-2 text-sm font-semibold text-[var(--color-accent)]"
          >
