...
function buildSectionSpecificites(cityName: string): CityGuideSection {
  return {
    ...
    paragraphs: [
      ...
      "Le standard simple : détail de la rue + distance camion→porte (en pas) + détail escalier/ascenseur + détail du passage le plus étroit. C’est ce qui rend les devis comparables.",
    ...
    checklist: [
      ...
      "détail entrée + passage le plus étroit (porte/couloir/palier)",
      "détail escalier (bas + palier) / ascenseur (cabine porte ouverte)",
      "détail des 2–3 meubles “limites” + objets fragiles/lourds",
    ],
  };
}
...
function buildSectionChecklistAvancee(cityName: string): CityGuideSection {
  return {
    ...
    paragraphs: [
      ...
      "Pas besoin de mesures au millimètre : 2–3 détails clés + une distance en pas suffisent souvent à cadrer une méthode réaliste.",
    ...
    checklist: [
      ...
      "Passage critique en détail (porte/couloir/escalier) + escalier/palier en détail",
      "Meubles “limites” en détail + “démontage oui/non”",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le meilleur standard est simple : 3 détails (rue, entrée, escalier/ascenseur) + la distance camion→porte (en pas). C’est ce qui rend les devis comparables.",
          "Ajoutez ensuite les meubles “limites” (canapé, frigo, armoire) : c’est l’anti‑surprise le plus efficace le jour J.",
        ],
        checklist: [
          "détail rue : où le camion peut s’arrêter + distance visible",
          "Distance camion→porte (en pas) + obstacles (marches/cour/couloir)",
          "détail entrée + passage le plus étroit",
          "détail escalier (bas + palier) / ascenseur (cabine porte ouverte)",
          "détail des 2–3 meubles “limites” + objets fragiles",
        ],
      },
      {
        id: "checklist-locale-avancee",
        ...
        checklist: [
          "J‑7 : détails accès + meubles volumineux, dossier prêt à partager",
    ...
    extraSections: [
      {
        ...
        checklist: [
          ...
          "détail entrée + passage le plus étroit",
          "détail escalier/ascenseur (cabine porte ouverte si possible)",
          "Liste + détail objets lourds/fragiles + meubles volumineux",
        ],
      },
      {
        id: "checklist-locale-avancee",
        ...
        checklist: [
          "Même format de détails pour tous (rue/entrée/escalier/ascenseur)",
          "Distance camion→porte indiquée (en pas) + étage/ascenseur",
          "Meubles “limites” listés + détail près d’un passage",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : détail cabine d’ascenseur porte ouverte + détail du passage le plus étroit + distance camion→porte (en pas).",
      ...
      },
      {
        ...
        checklist: [
          "détail cabine d’ascenseur porte ouverte (ou escalier bas + palier)",
          "Distance camion→porte (en pas) + étage",
          "détail du passage le plus étroit + détail des meubles “limites”",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard efficace : détail rue + distance camion→porte + détail passage le plus étroit + détail escalier/ascenseur.",
        ...
        checklist: [
          ...
          "détail chemin extérieur (si maison) / escalier-ascenseur (si immeuble)",
      ...
      },
      {
        ...
        checklist: [
          "Maison : détail chemin extérieur (portail/allée/marches) + distance camion→porte",
          "Résidence : détail ascenseur cabine (porte ouverte) + détail palier",
          "détail passage le plus étroit + détail meubles “limites”",
          "Distance camion→porte (en pas) + étage/ascenseur",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : détail du trajet + distance camion→porte + détail ascenseur/escalier + détail du passage le plus étroit.",
          "Ajoutez les meubles volumineux et vous fiabilisez la méthode.",
        ],
        checklist: [
          "détail du chemin camion→entrée (si accès indirect)",
          "Distance camion→porte (en pas)",
          "détail ascenseur (cabine) / escalier (bas + palier)",
          "détail passage le plus étroit",
          "détail meubles volumineux + objets fragiles",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "En 2–3 détails, vous décrivez le trajet mieux que n’importe quel texte.",
          "Ajoutez ensuite les meubles “limites” et vous fiabilisez la méthode.",
        ],
        checklist: [
          "détail du trajet complet camion→entrée (2–3 détails si besoin)",
          "Distance camion→porte (en pas) + étage",
          "détail ascenseur (cabine) / escalier (bas + palier)",
          "détail passage le plus étroit + détail meubles volumineux",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Poissy, un devis fiable dépend surtout du temps réel : portage, étages, passages. Une détail rend ces contraintes évidentes.",
          "Le standard : détail rue + distance camion→porte + détail escalier/ascenseur + détail passage le plus étroit.",
      ...
      },
      {
        ...
        checklist: [
          ...
          "Distance camion→porte (en pas) + étage",
          "détail canapé/armoire/frigo + mention démontage (oui/non)",
          "Zone tampon + couloir dégagé avant arrivée",
        ],
      },
    ],
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail du chemin extérieur (si maison) ou une détail ascenseur/escalier (si immeuble) suffit souvent à fiabiliser la manutention.",
      ...
      },
      {
        ...
        checklist: [
          "Maison : détail chemin extérieur (porte→rue) + obstacles/marches",
          "Résidence : détail ascenseur cabine (porte ouverte) + détail palier",
          "Distance camion→porte (en pas) + étage",
          "détail passage le plus étroit + détail meubles “limites”",
          "Zone tampon + couloir dégagé avant arrivée",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : détail escalier (bas + palier) + détail passage le plus étroit + distance camion→porte.",
          "Ajoutez les meubles volumineux et vous fiabilisez la méthode.",
        ],
        checklist: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Une détail du passage le plus étroit + une détail escalier/palier suffit souvent à cadrer la méthode sur les gros meubles.",
        ...
        checklist: [
          ...
          "détail escalier/palier ou ascenseur cabine (porte ouverte)",
          "Distance camion→porte (en pas) + étage",
          "détail meubles “limites” + mention démontage (oui/non)",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard : détail rue + distance camion→porte + détail passage le plus étroit + détail escalier/ascenseur.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Une détail du point critique suffit souvent à éviter un devis trop optimiste.",
          "Avec la même base d’info, vous comparez des devis comparables.",
        ],
        checklist: [
          "détail du point critique (porte/couloir/palier tournant)",
          "détail escalier/ascenseur + palier",
          "Distance camion→porte (en pas) + étage",
          "détail meubles “limites” + mention démontage (oui/non)",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail du chemin + distance camion→porte + détail ascenseur/escalier suffisent souvent à fiabiliser le chiffrage.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "En 2–3 détails, vous évitez les devis qui sous-estiment l’accès indirect.",
    ...
    extraSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Une détail du passage le plus étroit suffit souvent à cadrer la méthode (démontage/protection) sur les gros meubles.",
          "Ajoutez ensuite les meubles “limites” et vous évitez les surprises.",
        ],
        checklist: [
          "détail passage le plus étroit + détail escalier/ascenseur",
          "Distance camion→porte (en pas) + étage/ascenseur",
          "détail meubles “limites” + mention démontage (oui/non)",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : détail rue + distance camion→porte (en pas) + détail escalier/ascenseur. Ajoutez le passage le plus étroit pour fiabiliser les gros meubles.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Deux détails (passage étroit + escalier/ascenseur) + distance en pas suffisent souvent à rendre les devis comparables.",
          "Ajoutez les meubles “limites” pour sécuriser la méthode.",
        ],
        checklist: [
          "Distance camion→porte (en pas) + étage/ascenseur",
          "détail passage le plus étroit + détail escalier/palier",
          "détail meubles “limites” + mention démontage (oui/non)",
          "Zone tampon + couloir dégagé avant arrivée",
          "Sac perso + boîte “essentiels 24h” hors camion",
        ],
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard le plus efficace : détail cabine d’ascenseur porte ouverte (ou escalier bas + palier) + distance camion→porte (en pas).",
          "Ajoutez une détail du passage le plus étroit et vos devis deviennent comparables.",
        ],
        checklist: [
          "détail ascenseur (cabine) / escalier (bas + palier)",
          "Distance camion→porte (en pas)",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Une détail cabine porte ouverte + une détail du passage le plus étroit suffisent souvent à fiabiliser les gros meubles.",
          "Avec la même base, vous comparez des devis comparables.",
        ],
        checklist: [
          "détail ascenseur cabine (porte ouverte) / escalier bas + palier",
          "détail passage le plus étroit (porte/couloir/escalier)",
          "Distance camion→porte (en pas) + étage",
          "détail canapé/armoire/frigo + mention démontage (oui/non)",
          "Zone tampon + couloir dégagé avant arrivée",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : détail rue + distance camion→porte (en pas) + détail escalier/ascenseur + détail du passage le plus étroit.",
      ...
      },
      {
        ...
        checklist: [
          "Distance camion→porte (en pas) + étage/ascenseur",
          "détail passage le plus étroit + détail escalier/ascenseur",
          "Meubles “limites” listés + détail + démontage (oui/non)",
          "2–3 dates possibles si flexible (meilleurs créneaux)",
          "Zone tampon + sac perso hors camion",
        ],
      },
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : détail rue + distance camion→porte + détail escalier/ascenseur + détail du passage le plus étroit. En maison, ajoutez le chemin extérieur (portail/allée/marches).",
      ...
      },
      {
        ...
        checklist: [
          "Maison : détail chemin extérieur (porte→rue) + obstacles/marches",
          "Immeuble : détail ascenseur cabine (porte ouverte) / escalier bas + palier",
          "Distance camion→porte (en pas) + étage",
          "détail passage le plus étroit + détail meubles “limites”",
          "Zone tampon + couloir dégagé avant arrivée",
        ],
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard : détail rue + distance camion→porte (en pas) + détail escalier/ascenseur + détail du passage le plus étroit.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : distance camion→porte (en pas) + détail escalier/ascenseur + détail passage le plus étroit. Ajoutez ensuite vos meubles volumineux.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Une détail du passage le plus étroit + une détail escalier/ascenseur rend le chiffrage beaucoup plus réaliste.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Rezé, la fiabilité d’un devis dépend surtout de deux choses : un volume réaliste (détails des pièces + annexes) et un accès clair (stationnement, distance de portage, passages).",
          "Le standard simple : détail rue + distance camion→porte (en pas) + détail escalier/ascenseur (si applicable) + détail du passage le plus étroit.",
          "Avec ça, vous comparez des devis comparables, sans surprises le jour J.",
        ],
        checklist: [
          "détail rue : stationnement/arrêt possible + distance",
          "Distance camion→porte (en pas)",
          "détail entrée + passage le plus étroit",
          "détail escalier/ascenseur + palier (si applicable)",
          "détail meubles volumineux + objets fragiles",
        ],
      },
    ],
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail de cabine d’ascenseur porte ouverte + la distance camion→porte (en pas) suffisent souvent à fiabiliser les devis sur les gros meubles.",
          "Ajoutez le passage le plus étroit et vous éliminez l’essentiel de l’incertitude.",
        ],
        checklist: [
          "détail du trajet camion→entrée (si accès indirect)",
          "Distance camion→porte (en pas) + étage",
          "détail ascenseur (cabine) / escalier (bas + palier)",
          "détail passage le plus étroit (porte/couloir)",
          "détail meubles volumineux + objets fragiles",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : détails des annexes + détail rue + distance camion→porte (en pas) + passage le plus étroit.",
          "Avec une base claire, vous comparez des devis comparables et vous évitez les ajustements.",
        ],
        checklist: [
          "détails annexes (garage/cave/cellier) si existantes",
          "détail rue : stationnement/arrêt possible",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le meilleur standard : détail du chemin porte→rue + détail rue (où s’arrêter) + distance camion→porte (en pas).",
          "Ajoutez le passage le plus étroit à l’intérieur et vous fiabilisez les gros meubles.",
        ],
        checklist: [
          "détail du chemin extérieur (porte → rue) + obstacles/marches",
          "détail rue : stationnement/arrêt possible",
          "Distance camion→porte (en pas)",
          "détail passage le plus étroit (porte/couloir)",
          "détail meubles volumineux + objets fragiles",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard : détail rue + distance camion→porte (en pas) + détail escalier/ascenseur (si applicable) + détail du passage le plus étroit.",
        ...
        checklist: [
          ...
          "détail entrée + passage le plus étroit",
          "détail escalier/ascenseur + palier (si applicable)",
          "Liste + détail objets fragiles/valeur + meubles volumineux",
        ],
      },
    ],
  },
    ...
    extraSections: [
      {
        ...
        checklist: [
          "détail rue : où s’arrêter + distance visible",
          "Distance camion→porte (en pas)",
          "détail entrée + passage le plus étroit",
          "détail escalier (bas + palier) / ascenseur (cabine)",
          "Zone tampon près de la porte + détail meubles volumineux",
        ],
      },
    ],
  },
    ...
    extraSections: [
      {
        ...
        checklist: [
          ...
          "détail entrée + passage le plus étroit",
          "détail escalier/ascenseur + palier",
          "Liste + détail objets fragiles/lourds + meubles volumineux",
        ],
      },
    ],
  },
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard le plus efficace : détail de la rue + distance camion→porte (en pas) + détail escalier/palier (ou ascenseur cabine). Ajoutez ensuite les meubles volumineux.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le bon réflexe : détail escalier (bas + palier) + détail du passage le plus étroit. Ajoutez la distance camion→porte et les gros meubles.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Mulhouse, le devis fiable est celui qui connaît votre logistique réelle : stationnement, portage, et passages. Le volume se fiabilise avec les détails des pièces, l’accès avec 2–3 détails clés.",
          "Le standard simple : détail rue + distance camion→porte + détail escalier/ascenseur. Ajoutez les meubles volumineux et vous sécurisez le chiffrage.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Colmar, la fiabilité d’un devis dépend surtout de l’accès : distance de portage, étages, et passages. Une détail rend ces contraintes évidentes.",
          "Le bon standard : détail de la rue + détail entrée/passage + détail escalier/ascenseur. Ensuite, annoncez les meubles volumineux “limites”.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Ajoutez une détail escalier/ascenseur et une détail du passage le plus étroit : vous fiabilisez les devis sur les gros meubles.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Troyes, le devis fiable combine deux choses : un volume réaliste (détails des pièces) et un accès clair (stationnement, portage, passages).",
        ...
        checklist: [
          "détails des pièces + meubles volumineux",
          "détail rue : arrêt possible + distance",
          "Distance camion→porte (court/moyen/long)",
          "détail passage le plus étroit",
          "détail escalier/ascenseur",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Ajoutez la distance camion→porte et la détail escalier/ascenseur pour fiabiliser la manutention.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail de l’entrée + une détail escalier/ascenseur suffit souvent à éviter les devis trop optimistes sur les gros meubles.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Illkirch‑Graffenstaden, la fiabilité d’un devis dépend du trajet réel camion→porte et de la taille de l’ascenseur. Une détail de cabine porte ouverte clarifie instantanément.",
    ...
    extraSections: [
      {
        ...
        checklist: [
          "détail chemin extérieur (si maison) : porte → rue",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : distance camion→porte + détail escalier/palier + détail du passage le plus étroit. Avec ça, les devis deviennent comparables.",
          "Ajoutez les objets lourds/fragiles pour aligner la méthode (protection, manutention).",
        ],
        checklist: [
          "détail rue : arrêt possible + distance",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Charleville‑Mézières, un devis fiable se gagne sur la clarté : accès + volume + date. L’accès se fiabilise avec 3 détails (rue, entrée, escalier/ascenseur).",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail du passage le plus étroit + une détail escalier/ascenseur suffisent souvent à fiabiliser les devis sur les gros meubles.",
          "Objectif : comparer des devis comparables à prestation identique.",
        ],
        checklist: [
          "détail stationnement/arrêt possible",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Même sans mesures, une estimation en pas + une détail escalier/palier rendent le chiffrage réaliste.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard efficace : détail rue + distance camion→porte + détail escalier/ascenseur.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail du passage le plus étroit + une détail escalier/ascenseur suffit souvent à rendre le devis réaliste pour les gros meubles.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le bon standard : distance camion→porte + détail escalier/ascenseur + détail du passage le plus étroit.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Même sans mesures, une estimation en pas + une détail escalier/ascenseur rend le chiffrage réaliste.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Forbach, un devis fiable se gagne sur la clarté : accès + volume + date. L’accès se fiabilise avec 3 détails (rue, entrée, escalier/ascenseur).",
          "Une détail du passage le plus étroit suffit souvent à éviter un devis trop optimiste sur les gros meubles.",
          "Objectif : comparer des devis comparables, sans ajustements le jour J.",
        ],
        checklist: [
          "détail rue : stationnement possible",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : détail cabine porte ouverte + distance camion→porte + détail du passage le plus étroit.",
      ...
      },
      {
        ...
        checklist: [
          "détail cabine d’ascenseur porte ouverte + détail palier (si immeuble)",
          "Mesurer “en pas” la distance camion→porte (et la noter)",
          "Identifier 1 point critique : porte/couloir/escalier le plus étroit (détail)",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail de cabine d’ascenseur + distance camion→porte suffit souvent à fiabiliser les devis.",
          "Ajoutez le passage le plus étroit et vous évitez les devis trop optimistes.",
        ],
        checklist: [
          "détail ascenseur (cabine) / escalier",
          "Distance camion→porte (en pas)",
          "détail entrée + passage le plus étroit",
          "détail rue : arrêt possible",
          "détail meubles volumineux",
      ...
      },
      {
        ...
        checklist: [
          "détail ascenseur cabine + largeur porte (détail suffit, pas besoin de mesure)",
          "détail du passage le plus étroit (porte/couloir/escalier)",
          "détail du canapé/armoire/frigo + mention démontage souhaité (oui/non)",
          "Distance camion→porte (en pas) + étage",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard : distance camion→porte + détail escalier/ascenseur + détail passage le plus étroit.",
      ...
      },
      {
        ...
        checklist: [
          "Distance camion→porte (en pas) + étage/ascenseur",
          "détail escalier/palier ou ascenseur cabine (porte ouverte)",
          "détail du passage le plus étroit + détail meubles volumineux",
          "Objets lourds/fragiles listés (protection attendue)",
          "Zone tampon + étiquetage par pièce + priorité",
        ],
      },
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Sarcelles, l’accès et le portage sont souvent les facteurs de temps principaux. Une détail rend ces contraintes évidentes.",
          "Le standard simple : détail rue + distance camion→porte + détail escalier/ascenseur.",
          "Ajoutez les meubles volumineux pour fiabiliser la méthode.",
        ],
        checklist: [
          "détail rue : stationnement possible",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Avec une détail de cabine (ou escalier) + une détail du passage le plus étroit, vous verrouillez la méthode.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une estimation en pas + une détail escalier/palier rend le chiffrage beaucoup plus réaliste.",
          "Ajoutez les objets lourds/fragiles pour aligner la méthode (protection, manutention).",
        ],
        checklist: [
          "Distance camion→porte (en pas)",
      ...
      },
      {
        ...
        checklist: [
          "détail rue + endroit d’arrêt possible (même approximatif)",
          "Distance camion→porte (en pas) + présence de marches/couloir long",
          "détail escalier/ascenseur + palier",
          "détail passage le plus étroit + meubles volumineux",
          "Objets lourds/fragiles listés (protection attendue)",
        ],
      },
    ],
    ...
    extraSections: [
      ...
      },
      {
        ...
        checklist: [
          ...
          "détail passage le plus étroit + détail canapé/armoire/frigo",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Maisons‑Alfort, le duo gagnant pour fiabiliser un devis : distance camion→porte + détail escalier/ascenseur + détail passage le plus étroit.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Une détail du passage le plus étroit + une détail escalier/ascenseur suffisent souvent à cadrer.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Alfortville, le devis fiable dépend surtout de l’accès : stationnement, portage, passages. Une détail rend ces contraintes évidentes.",
          "Le standard : distance camion→porte + détail escalier/ascenseur + détail passage le plus étroit.",
          "Ajoutez les objets lourds/fragiles pour aligner la méthode.",
        ],
        checklist: [
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail cabine d’ascenseur + distance camion→porte suffit souvent à fiabiliser le chiffrage des gros meubles.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Une détail de cabine + une détail du passage le plus étroit suffisent souvent à fiabiliser la méthode.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Aix‑en‑Provence, un devis fiable dépend surtout du trajet réel camion→porte et des passages intérieurs. Même sans mesures, quelques détails suffisent à fiabiliser l’accès.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Avignon, le portage et l’accès intérieur sont souvent les facteurs de temps principaux. Une détail de la rue + une détail de l’entrée + une détail escalier/ascenseur rendent le devis beaucoup plus fiable.",
        ...
        checklist: [
          ...
          "détail entrée + passage le plus étroit",
          "détail escalier/ascenseur",
          "détail meubles volumineux (groupée)",
        ],
      },
    ],
  },
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le meilleur standard : détail ascenseur cabine porte ouverte + distance camion→porte + détail du passage le plus étroit.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Antibes, un devis fiable se gagne sur la logistique réelle : stationnement, portage, passages. Une détail rend ces contraintes évidentes.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail du chemin porte→rue + une détail du passage le plus étroit rendent le devis beaucoup plus fiable.",
          "Ajoutez les objets fragiles/lourds pour aligner la méthode et l’assurance.",
        ],
        checklist: [
          "détail chemin extérieur (si maison) : porte → rue",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard le plus simple : détail de la rue + distance camion→porte + détail escalier/ascenseur. Ensuite, vous comparez des devis comparables.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Saint‑Raphaël, le repère le plus utile pour comparer des devis est la distance camion→porte (même en pas) + une détail de l’entrée.",
          "Ajoutez ensuite une détail escalier/ascenseur et une détail du passage le plus étroit : vous fiabilisez le chiffrage des gros meubles.",
    ...
    extraSections: [
      {
        ...
        checklist: [
          ...
          "détail meubles volumineux + mention tri effectué (oui/non)",
        ],
      },
    ],
  },
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Martigues, le portage est souvent le paramètre sous-estimé qui crée des écarts de devis. Une estimation simple (court/moyen/long) + une détail de la rue stabilise le chiffrage.",
          "Ajoutez une détail escalier/ascenseur et une détail du passage le plus étroit : vous fiabilisez les devis sur les gros meubles.",
          "Objectif : comparer des devis comparables, sans ajustements le jour J.",
        ],
        checklist: [
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le meilleur réflexe : détail cabine d’ascenseur porte ouverte + détail du palier + distance camion→porte. Ça fiabilise immédiatement le chiffrage des gros meubles.",
          "Objectif : éliminer l’incertitude pour comparer des devis comparables.",
        ],
        checklist: [
          "détail rue : endroit où s’arrêter + contraintes visibles",
          "Distance camion→porte (en pas)",
          "détail entrée + passage le plus étroit",
          "détail ascenseur (cabine) / escalier (bas + palier)",
          "détail meubles volumineux + objets fragiles",
      ...
      },
      {
        ...
        checklist: [
          "détail cabine d’ascenseur porte ouverte + détail palier",
          "détail du passage le plus étroit (porte/couloir/escalier)",
          "Distance camion→porte (en pas) + étage",
          "détail des meubles “limites” + mention démontage (oui/non)",
      ...
      },
      {
        ...
        checklist: [
          "Ascenseur : cabine + porte ouverte en détail (ou escalier bas + palier)",
          "Passage critique : détail du point le plus étroit (porte/couloir/palier)",
          "Meubles limites : 2–3 détails + “démontage oui/non”",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une estimation simple de la distance camion→porte + une détail de l’escalier/palier rendent le chiffrage beaucoup plus réaliste.",
          "Ajoutez les objets lourds/fragiles pour aligner la méthode (protection, manutention).",
        ],
        checklist: [
          "détail stationnement/arrêt possible",
      ...
      },
      {
        ...
        checklist: [
          "Distance camion→porte (en pas) + étage/ascenseur",
          "détail escalier/palier ou ascenseur cabine (porte ouverte)",
          "détail du passage le plus étroit + détail canapé/frigo/armoire",
      ...
      },
      {
        ...
        checklist: [
          ...
          "Passage critique : détail du point le plus étroit + détail escalier/palier",
          "Objets lourds/fragiles listés + protection attendue",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le meilleur standard : distance camion→porte + détail du passage le plus étroit + détail escalier/ascenseur. Avec ça, les devis deviennent comparables.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Une détail du passage le plus étroit + une détail escalier/ascenseur suffit souvent à cadrer une méthode réaliste.",
          "Avec la même base d’info, vous comparez des devis comparables.",
        ],
        checklist: [
          "détail passage le plus étroit (porte/couloir/escalier)",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail du trajet + une détail escalier/ascenseur suffit souvent à éviter un devis sous‑dimensionné.",
          "Gardez un dossier identique pour tous les déménageurs pour comparer proprement.",
        ],
        checklist: [
          "détail du chemin camion→entrée (si portage/cour)",
          "Distance camion→porte (en pas)",
          "détail entrée + passage le plus étroit",
          "détail escalier/ascenseur + palier",
          "détail objets fragiles/lourds (groupée)",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "En 2–3 détails, vous rendez le trajet évident et vous fiabilisez les devis.",
        ...
        checklist: [
          ...
          "détail escalier/ascenseur + palier",
          "Meubles volumineux “limites” listés + détail",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Deux détails et une distance en pas valent mieux qu’un long texte.",
          "Cochez ces points pour fiabiliser la journée.",
        ],
        checklist: [
          "Trajet camion→entrée documenté (2–3 détails) + distance en pas",
          "Ascenseur/escalier : détail bas + palier / cabine porte ouverte",
          "Passage le plus étroit en détail + meubles limites en détail",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail de cabine porte ouverte + distance camion→porte rend le devis très fiable, sans effort.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Pas besoin de mesures au millimètre : une détail de cabine porte ouverte suffit souvent.",
      ...
      },
      {
        ...
        checklist: [
          "Ascenseur : détail cabine porte ouverte (ou escalier bas + palier)",
          "Passage critique : détail du point le plus étroit (porte/couloir)",
          "Meubles limites : détail + “démontage oui/non”",
          "Distance camion→porte (en pas) + étage",
    ...
    extraSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Une détail du passage le plus étroit + une détail escalier/palier font souvent toute la différence.",
          "Ajoutez ensuite les meubles “limites” : le devis devient réaliste.",
        ],
        checklist: [
          "détail passage le plus étroit + détail escalier/palier",
      ...
      },
      {
        ...
        checklist: [
          "Passage critique en détail + escalier/palier en détail",
          "Meubles limites en détail + démontage oui/non",
          "Distance camion→porte (en pas) + étage/ascenseur",
          "Cartons lourds limités + étiquetage clair",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail de cabine porte ouverte + distance camion→porte rend les devis comparables immédiatement.",
      ...
      },
      {
        ...
        checklist: [
          "Ascenseur : cabine porte ouverte en détail + détail palier",
          "Portage : distance camion→porte notée (en pas)",
          "Passage critique : détail du point le plus étroit",
          "Meubles limites : détail + “démontage oui/non”",
          "Jour J : couloir dégagé + zone tampon + 1 référent accès",
        ],
      },
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Colombes, la fiabilité vient d’un dossier standard : accès (rue/entrée/escalier) + volume (détails pièces) + date (ou 2–3 options).",
          "L’accès est le facteur qui crée le plus d’écarts : portage long, passage étroit, ascenseur petit. Montrez-le en détail.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le meilleur standard : détail ascenseur (cabine) + détail du passage le plus étroit + distance camion→porte.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Avec deux détails (cabine + passage) et la distance en pas, vous verrouillez la méthode.",
          "Ensuite, tout le monde chiffre la même base.",
        ],
        checklist: [
          "détail cabine d’ascenseur porte ouverte (ou escalier bas + palier)",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Si vous avez un meuble “limite”, annoncez-le tôt. Une détail du passage le plus étroit suffit souvent à fiabiliser le devis.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Avec 2–3 détails clés et la distance en pas, les devis deviennent comparables.",
          "Ajoutez ensuite les meubles “limites” et vous sécurisez la méthode.",
        ],
        checklist: [
          "Distance camion→porte (en pas) + étage/ascenseur",
          "détail passage le plus étroit + détail escalier/ascenseur",
          "détail meubles volumineux + mention démontage (oui/non)",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail de cabine porte ouverte + une détail du palier suffisent souvent à fiabiliser les devis sur les gros meubles.",
          "Ajoutez la distance camion→porte et vous supprimez une grande partie de l’incertitude.",
        ],
        checklist: [
          "détail ascenseur (cabine) / escalier (bas + palier)",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Une détail de cabine + une détail du palier répondent à la majorité des questions sur les gros meubles.",
          "Ensuite, tout le monde chiffre la même base.",
        ],
        checklist: [
          "détail cabine d’ascenseur porte ouverte + détail palier",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le meilleur standard : distance camion→porte + détail escalier/palier + détail passage le plus étroit.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Même sans mesures, une estimation en pas + une détail escalier/palier rendent les devis beaucoup plus réalistes.",
          "Gardez ces infos identiques pour tous les déménageurs pour comparer proprement.",
        ],
        checklist: [
          "détail rue : arrêt possible + distance",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le meilleur standard : distance camion→porte + détail passage le plus étroit + détail escalier/ascenseur.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail du trajet (ou 2–3 détails clés) + distance camion→porte rendent le chiffrage beaucoup plus réaliste.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail d’ascenseur cabine porte ouverte + distance camion→porte suffit souvent à rendre les devis comparables.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Deux détails (cabine + passage étroit) + la distance en pas suffisent souvent à rendre les devis comparables.",
          "Ajoutez ensuite les meubles limites et vous sécurisez la méthode.",
        ],
        checklist: [
          "détail ascenseur cabine porte ouverte (ou escalier bas + palier)",
          "détail passage le plus étroit (porte/couloir)",
          "Distance camion→porte (en pas) + étage",
          "détail meubles “limites” + mention démontage (oui/non)",
          "Jour J : référent accès + couloir dégagé",
    ...
    extraSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Une détail du passage le plus étroit suffit souvent à cadrer la méthode (démontage/protection).",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail d’ascenseur cabine porte ouverte + distance camion→porte rend les devis comparables immédiatement.",
          "Ajoutez les objets fragiles/lourds pour aligner la méthode et l’assurance.",
        ],
        checklist: [
          "détail ascenseur (cabine) / escalier (bas + palier)",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Une détail de cabine porte ouverte + la distance en pas suffisent souvent à rendre les devis comparables.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Même une estimation en pas + une détail escalier/palier suffisent souvent à cadrer correctement.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Une distance en pas + deux détails clés (passage étroit + escalier/ascenseur) suffisent souvent à cadrer correctement.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard le plus simple : distance camion→porte + détail passage le plus étroit + détail escalier/ascenseur.",
          "Ajoutez les meubles volumineux et vous évitez les devis trop optimistes.",
        ],
        checklist: [
          "Distance camion→porte (court/moyen/long)",
      ...
      },
      {
        ...
        paragraphs: [
          "Le but : fiabiliser la méthode sur les passages et le portage, pour obtenir des devis comparables.",
          "Une détail du passage le plus étroit + une détail escalier/ascenseur rendent le chiffrage beaucoup plus réaliste.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le bon réflexe : détail de la rue (où s’arrêter) + détail du chemin de portage (si long) + détail escalier/ascenseur. Ensuite, annoncez les meubles lourds/fragiles : c’est ce qui change la méthode.",
          "Objectif : comparer des devis comparables, sans ajustements le jour J.",
        ],
        checklist: [
          "détail rue : stationnement/arrêt possible + distance",
          ...
          "détail entrée + passage le plus étroit",
          "détail escalier (bas + palier) / ascenseur (cabine)",
          "Liste + détail objets lourds/fragiles (frigo, vitrine, piano…)",
        ],
      },
    ],
  },
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le meilleur standard : détail de la rue + détail de l’entrée + détail ascenseur (cabine) ou escalier (bas + palier). Ajoutez ensuite les meubles volumineux “limites”.",
        ...
        checklist: [
          ...
          "détail entrée + couloir/porte la plus étroite",
          "détail ascenseur (cabine) / escalier (bas + palier)",
          "détail des meubles volumineux + objets fragiles",
        ],
      },
    ],
  },
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Même sans mesures, distance camion→porte + détail du passage le plus étroit suffisent souvent à cadrer correctement les gros meubles.",
        ...
        checklist: [
          ...
          "détail passage le plus étroit (porte/couloir)",
          "détail escalier/ascenseur",
          "détail meubles volumineux + 2–3 dates possibles",
        ],
      },
    ],
  },
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail escalier/palier (ou ascenseur cabine) + une détail de la rue suffit souvent à éviter un devis trop optimiste.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le bon réflexe : détail de la rue + distance camion→porte + détail escalier/ascenseur. Ajoutez les meubles volumineux et vous fiabilisez le chiffrage.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail de la rue + une détail escalier/ascenseur + distance camion→porte rend le devis beaucoup plus réaliste.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : distance camion→porte + détail ascenseur/escalier + détail passage le plus étroit. Avec ça, les devis deviennent comparables.",
          "Ajoutez une détail des meubles volumineux et vous sécurisez le chiffrage.",
        ],
        checklist: [
          "Distance camion→porte (en pas)",
          "détail rue : stationnement possible",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Saint‑Laurent‑du‑Var, les écarts de devis viennent souvent de l’accès : portage long, ascenseur petit, passage étroit. Une détail rend ces points évidents.",
          "Le bon réflexe : détail cabine d’ascenseur + distance camion→porte + détail du passage le plus étroit.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard efficace : détail rue + distance camion→porte + détail escalier/ascenseur. Ajoutez les meubles volumineux et le devis devient réaliste.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail du passage le plus étroit + une détail escalier/ascenseur suffisent souvent à fiabiliser le chiffrage des gros meubles.",
          "Ajoutez les objets lourds/fragiles pour aligner la méthode (protection, manutention).",
        ],
        checklist: [
          "détail stationnement/arrêt possible",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : détail rue (où s’arrêter) + distance camion→porte (en pas) + détail escalier/ascenseur. Ajoutez ensuite le passage le plus étroit pour fiabiliser les gros meubles.",
          "Objectif : comparer des devis comparables, sans ajustements le jour J.",
        ],
        checklist: [
          "détail rue : stationnement/arrêt possible + distance visible",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Même sans mesures, distance camion→porte + détail escalier/palier rendent les devis beaucoup plus réalistes.",
          "Ajoutez le passage le plus étroit et les meubles volumineux pour sécuriser la méthode.",
        ],
        checklist: [
          "détail rue : arrêt possible",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : détail de la rue + distance camion→porte + détail escalier/ascenseur. Ajoutez ensuite les meubles volumineux.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Une détail de cabine d’ascenseur (si présent) + une détail du passage le plus étroit suffisent souvent à fiabiliser le chiffrage des gros meubles.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : détail rue + distance camion→porte + détail escalier/ascenseur + détail passage le plus étroit.",
          "Avec ça, les devis deviennent comparables et les surprises diminuent fortement.",
        ],
        checklist: [
          "détail stationnement/arrêt possible",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard : distance camion→porte + détail passage le plus étroit + détail escalier/ascenseur.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Même sans mesures, distance camion→porte + détail passage le plus étroit suffisent souvent à cadrer correctement.",
          "Ajoutez une détail des meubles volumineux pour sécuriser la méthode.",
        ],
        checklist: [
          "détail rue : stationnement possible",
          "Distance camion→porte (court/moyen/long)",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Denain, le devis fiable se gagne sur la visibilité : accès + volume + date. L’accès se fiabilise avec 3 détails (rue, entrée, escalier/ascenseur).",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Même sans mesures, distance camion→porte + détail escalier/ascenseur rendent le chiffrage réaliste.",
          "Ajoutez une détail des meubles volumineux pour sécuriser la méthode.",
        ],
        checklist: [
          "détail rue : stationnement possible",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : distance camion→porte + détail passage le plus étroit + détail escalier/ascenseur.",
          "Ajoutez les objets lourds/fragiles pour aligner la méthode (protection, manutention).",
        ],
        checklist: [
          "détail rue : arrêt possible",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard le plus efficace : détail de la rue + distance camion→porte (en pas) + détail ascenseur (cabine) ou escalier (bas + palier). Ajoutez ensuite le passage le plus étroit.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Saint‑Avold, un devis fiable se gagne sur la clarté : accès + volume + date. L’accès se fiabilise avec quelques détails bien prises.",
          "Le standard : distance camion→porte + détail escalier/ascenseur + détail du passage le plus étroit.",
          "Ajoutez les meubles volumineux “limites” pour éviter les surprises le jour J.",
        ],
        checklist: [
          "détail rue : arrêt possible + distance",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Sarreguemines, la fiabilité d’un devis dépend du temps réel : portage, étages, passages. Une détail rend ces contraintes évidentes.",
          "Le standard : détail rue + distance camion→porte + détail escalier/ascenseur + détail passage le plus étroit.",
          "Ajoutez les objets lourds/fragiles pour aligner la méthode (protection, manutention).",
        ],
        checklist: [
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Même sans mesures, distance camion→porte + détail passage le plus étroit + détail escalier/ascenseur rendent le chiffrage réaliste.",
          "Ajoutez les objets lourds/fragiles pour aligner la méthode (protection, manutention).",
        ],
        checklist: [
          "détail stationnement/arrêt possible",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Même sans mesures, une distance en pas + 2–3 détails (rue, entrée, escalier/ascenseur) suffisent à rendre le chiffrage réaliste.",
          "Ajoutez les meubles volumineux et vous comparez des devis comparables.",
        ],
        checklist: [
          "détail rue : stationnement/arrêt possible",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard : détail rue + distance camion→porte (en pas) + détail passage le plus étroit + détail escalier/ascenseur si besoin.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Laval, le devis fiable dépend surtout de l’accès réel : stationnement, portage, et passages. Une détail rend ces contraintes évidentes.",
          "Le standard simple : distance camion→porte (en pas) + détail escalier/ascenseur + détail du passage le plus étroit.",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : détail rue + distance camion→porte (en pas) + détail du passage le plus étroit + détail escalier/ascenseur si besoin.",
          "Ajoutez une détail des meubles volumineux et vous sécurisez la méthode.",
        ],
        checklist: [
          "détail rue : stationnement/arrêt possible",
          "Distance camion→porte (court/moyen/long ou en pas)",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Même sans mesures, distance camion→porte (en pas) + détail du passage le plus étroit suffisent souvent à cadrer correctement.",
          "Ajoutez la détail escalier/ascenseur si vous êtes en étage, et vos devis deviennent comparables.",
        ],
        checklist: [
          "Distance camion→porte (en pas) + étage/ascenseur",
          "détail rue : arrêt possible",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          "À Saumur, la fiabilité d’un devis dépend de l’accès (portage, passages) et du volume réel (détails pièces + annexes).",
          "Le standard simple : détail rue + distance camion→porte (en pas) + détail passage le plus étroit + détail escalier/ascenseur si besoin.",
          "Avec la checklist ci-dessous, vous comparez des devis comparables.",
        ],
        checklist: [
          "détails pièces + annexes (si existantes)",
          "détail rue : arrêt possible + distance",
          "Distance camion→porte (en pas) + étage/ascenseur",
          "détail passage le plus étroit",
          "détail meubles volumineux",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Même sans mesures, distance camion→porte (en pas) + détail du passage le plus étroit rendent les devis beaucoup plus réalistes.",
          "Ajoutez la détail escalier/ascenseur si vous êtes en étage, et vous sécurisez la méthode.",
        ],
        checklist: [
          "détail rue : stationnement/arrêt possible",
          "Distance camion→porte (en pas)",
    ...
    extraSections: [
      {
        ...
        paragraphs: [
          ...
          "Le standard simple : détail rue + distance camion→porte (en pas) + détail passage le plus étroit. Ajoutez escalier/ascenseur si vous êtes en étage.",
