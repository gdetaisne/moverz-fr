...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Petit déménagement à Lille : transport petit volume & devis | Moverz",
  description:
    "Petit déménagement à Lille (petit volume) : options, fourchettes de prix, accès, timing. Comparez 3 devis minimum pros pour transporter quelques meubles/cartons.",
});
  ...
  return (
    <CityServicePage
      ...
      sections={[
        ...
        {
          title: "Les options les plus efficaces à Lille",
          paragraphs: [
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Regardez aussi la page “aide au déménagement à Lille” : main d’œuvre, matériel et options à la carte.",
        },
      ]}
    />
  );
