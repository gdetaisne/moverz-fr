...
export const metadata = generateCityServiceMetadata({
  citySlug: "lille",
  serviceSlug: "piano",
  title: "Déménagement piano Lille : transport sécurisé, devis",
  description:
    "Déménagement piano à Lille : piano droit ou à queue, accès, protections, assurance. Conseils + des devis comparables de pros pour un transport sécurisé.",
});
