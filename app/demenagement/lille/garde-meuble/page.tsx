...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Garde-meuble à Lille : box, stockage, tarifs & devis",
  description:
    "Garde-meuble à Lille : comparer box/self-stockage et solutions avec déménageur. Tailles, sécurité, assurance, conseils + des devis comparables via Moverz.",
});
