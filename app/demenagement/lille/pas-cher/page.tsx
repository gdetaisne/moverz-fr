...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Déménagement pas cher à Lille : astuces + devis comparables",
  description:
    "Déménagement pas cher à Lille : leviers concrets (dates, volume, formule) + des devis comparables comparables et sans spam. Payez moins sans sacrifier la fiabilité.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="pas-cher"
      badge="Budget"
      h1="Déménagement pas cher à Lille"
      ...
      sections={[
        {
          title: "Ce qui fait varier le prix à Lille",
          paragraphs: [
            "Le tarif dépend surtout du volume (m³), des accès (étage, ascenseur, stationnement) et de la période (été, week-ends, fin de mois).",
            "À Lille (et dans la métropole), l’accès et le stationnement peuvent augmenter le temps de portage : un devis “pas cher” sans détails finit souvent par une surprise.",
          ],
          bullets: [
      ...
      faqs={[
        {
          question: "Quand déménager moins cher à Lille ?",
          answer:
        ...
        },
        {
          ...
          answer:
            "Regardez aussi la page “petit déménagement à Lille” : sur petit volume, l’accès et le temps sur place font souvent la différence.",
        },
      ]}
    />
  );
