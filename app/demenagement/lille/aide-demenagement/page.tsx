...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Aide au déménagement à Lille : main d’œuvre, matériel, devis",
  description:
    "Aide au déménagement à Lille : porteurs, manutention, monte-meuble, matériel. Conseils + des devis comparables comparables pour une aide à la carte, sans spam.",
});
