...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Déménagement pas cher à Lyon : astuces + devis comparables",
  description:
    "Déménagement pas cher à Lyon : leviers concrets (dates, volume, formule) + des devis comparables comparables et sans spam. Payez moins sans sacrifier la fiabilité.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="pas-cher"
      badge="Budget"
      h1="Déménagement pas cher à Lyon"
      ...
      sections={[
        {
          title: "Ce qui fait varier le prix à Lyon",
          paragraphs: [
            "Le tarif dépend surtout du volume (m³), des accès (étage, ascenseur, stationnement) et de la période (été, week-ends, fin de mois).",
            "À Lyon, les accès peuvent être déterminants : étages sans ascenseur, stationnement, portage… Un devis “pas cher” sans détails finit souvent par une surprise.",
          ],
          bullets: [
      ...
      faqs={[
        {
          question: "Quand déménager moins cher à Lyon ?",
          answer:
        ...
        },
        {
          ...
          answer:
            "Regardez aussi la page “petit déménagement à Lyon” : sur petit volume, l’accès et le temps sur place font souvent la différence.",
        },
      ]}
    />
  );
