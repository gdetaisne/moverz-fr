...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Petit déménagement à Lyon (petit volume) : options, fourchettes de prix, accès, timing. comparez 5+ devis comparés pros pour transporter quelques meubles/cartons.",
});
