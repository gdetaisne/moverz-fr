...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Location camion déménagement à Lyon : quel volume choisir, prix, conditions (permis, caution), conseils stationnement + alternative : comparer des devis comparables pros.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="location-camion"
      badge="DIY"
      h1="Location de camion pour déménagement à Lyon"
      ...
      sections={[
        ...
        {
          title: "Stationnement à Lyon : le point sous-estimé",
          paragraphs: [
