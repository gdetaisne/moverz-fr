...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Aide au déménagement à Lyon : main d’œuvre, matériel, devis",
  description:
    "Aide au déménagement à Lyon : porteurs, manutention, monte-meuble, matériel. Conseils + des devis comparables comparables pour une aide à la carte, sans spam.",
});
