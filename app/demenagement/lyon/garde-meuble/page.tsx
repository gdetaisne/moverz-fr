...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Garde-meuble à Lyon : comparer box/self-stockage et solutions avec déménageur. Tailles, sécurité, assurance, conseils + des devis comparables via Moverz.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      sections={[
        {
          title: "Quand un garde-meuble est utile à Lyon ?",
          paragraphs: [
            ...
            "À Lyon, c’est aussi fréquent quand les dates ne s’alignent pas (bail, travaux), ou quand l’accès impose une organisation stricte.",
          ],
          bullets: [
