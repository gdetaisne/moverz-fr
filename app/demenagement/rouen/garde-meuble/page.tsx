...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Garde-meuble à Rouen : box, stockage, tarifs & devis | Moverz",
  description:
    "Garde-meuble à Rouen : comparer box/self-stockage et solutions avec déménageur. Tailles, sécurité, assurance, conseils + 3 devis minimum via Moverz.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      sections={[
        {
          title: "Quand un garde-meuble est utile à Rouen ?",
          paragraphs: [
            ...
            "À Rouen, c’est aussi très pratique pour lisser les dates (bail, travaux) ou stocker avant/après un déménagement longue distance.",
          ],
          bullets: [
