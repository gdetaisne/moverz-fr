...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Garde-meuble à Rouen : box, stockage, tarifs & devis",
  description:
    "Garde-meuble à Rouen : comparer box/self-stockage et solutions avec déménageur. Tailles, sécurité, assurance, conseils + des devis comparables via Moverz.",
});
