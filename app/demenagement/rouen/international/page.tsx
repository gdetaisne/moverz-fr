...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement international depuis/vers Rouen : modes de transport, formalités, assurance, stockage. Conseils + des devis comparables comparables via Moverz.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="international"
      badge="International"
      h1="Déménagement international depuis Rouen"
      subtitle="Un déménagement international demande une bonne organisation (transport, documents, assurance). Voici l’essentiel pour partir/arriver sereinement depuis Rouen."
      sections={[
        {
