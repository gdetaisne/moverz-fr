...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Petit déménagement à Rouen (petit volume) : options, fourchettes de prix, accès, timing. comparez des devis comparables pros pour transporter quelques meubles/cartons.",
});
