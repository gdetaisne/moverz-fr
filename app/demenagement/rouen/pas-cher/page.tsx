...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement pas cher à Rouen : leviers concrets (dates, volume, formule) + des devis comparables comparables et sans spam. Payez moins sans sacrifier la fiabilité.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="pas-cher"
      badge="Budget"
      h1="Déménagement pas cher à Rouen"
      ...
      sections={[
        {
          title: "Ce qui fait varier le prix à Rouen",
          paragraphs: [
            "Le tarif dépend surtout du volume (m³), des accès (étage, ascenseur, stationnement) et de la période (été, week-ends, fin de mois).",
            "À Rouen, un devis “pas cher” sans détails (accès, distance de portage, date) finit souvent par une surprise ou une qualité en baisse.",
          ],
          bullets: [
      ...
      faqs={[
        {
          question: "Quand déménager moins cher à Rouen ?",
          answer:
        ...
        },
        {
          ...
          answer:
            "Regardez aussi la page “petit déménagement à Rouen” : sur petit volume, l’accès et le temps sur place font souvent la différence.",
        },
      ]}
    />
  );
