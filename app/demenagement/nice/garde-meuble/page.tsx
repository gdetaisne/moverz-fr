...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Garde-meuble à Nice : box, stockage, tarifs & devis | Moverz",
  description:
    "Garde-meuble à Nice : comparer box/self-stockage et solutions avec déménageur. Tailles, sécurité, assurance, conseils + 3 devis minimum via Moverz.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="garde-meuble"
      badge="Stockage"
      h1="Garde-meuble à Nice"
      subtitle="Box de stockage, self-stockage, garde-meuble via déménageur… Comment choisir la bonne solution à Nice (sécurité, accès, taille) et obtenir des devis clairs."
      sections={[
        {
          title: "Quand un garde-meuble est utile à Nice ?",
          paragraphs: [
            ...
            "À Nice, c’est aussi pratique pour lisser les dates en période tendue (haute saison) et éviter de tout “caser” dans l’urgence.",
          ],
          bullets: [
