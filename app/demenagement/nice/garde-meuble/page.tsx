...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Garde-meuble à Nice : box, stockage, tarifs & devis",
  description:
    "Garde-meuble à Nice : comparer box/self-stockage et solutions avec déménageur. Tailles, sécurité, assurance, conseils + des devis comparables via Moverz.",
});
