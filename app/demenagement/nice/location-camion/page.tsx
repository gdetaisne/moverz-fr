...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Location camion déménagement Nice : volumes, prix & conseils | Moverz",
  description:
    "Location camion déménagement à Nice : quel volume choisir, prix, conditions (permis, caution), conseils stationnement + alternative : comparer 3 devis minimum pros.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="location-camion"
      badge="DIY"
      h1="Location de camion pour déménagement à Nice"
      subtitle="Vous déménagez en autonomie ? Choisir le bon utilitaire (volume, permis), éviter les pièges (assurance, caution) et gérer le stationnement niçois."
      sections={[
        {
          ...
          paragraphs: [
            ...
            "À Nice, les accès en centre-ville peuvent compliquer les gros gabarits : un véhicule bien dimensionné est souvent plus simple.",
          ],
          bullets: [
        ...
        {
          title: "Stationnement à Nice : à anticiper",
          paragraphs: [
