...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Location camion déménagement Nice : volumes, prix & conseils",
  description:
    "Location camion déménagement à Nice : quel volume choisir, prix, conditions (permis, caution), conseils stationnement + alternative : comparer des devis comparables pros.",
});
