...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Location camion déménagement à Nice : quel volume choisir, prix, conditions (permis, caution), conseils stationnement + alternative : comparer 5+ devis comparés pros.",
});
