...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Aide au déménagement à Nice : main d’œuvre, matériel, devis | Moverz",
  description:
    "Aide au déménagement à Nice : porteurs, manutention, monte-meuble, matériel. Conseils + 3 devis minimum comparables pour une aide à la carte, sans spam.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="aide-demenagement"
      badge="À la carte"
      h1="Aide au déménagement à Nice"
      ...
      sections={[
        {
          ...
          paragraphs: [
            ...
            "À Nice, les accès (rues étroites, stationnement, immeubles anciens) peuvent rendre un renfort utile même pour un petit volume.",
          ],
          bullets: [
        ...
        {
          title: "Monte-meuble : quand c’est pertinent à Nice",
          paragraphs: [
            ...
            "Il peut être plus rapide et plus sûr qu’une manutention longue dans les parties communes.",
          ],
          bullets: [
