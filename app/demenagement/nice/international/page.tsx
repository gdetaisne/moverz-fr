...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Déménagement international depuis Nice : Europe/monde, devis | Moverz",
  description:
    "Déménagement international depuis/vers Nice : modes de transport, formalités, assurance, stockage. Conseils + 3 devis minimum comparables via Moverz.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="international"
      badge="International"
      h1="Déménagement international depuis Nice"
      subtitle="Un déménagement international demande une bonne organisation (transport, documents, assurance). Voici l’essentiel pour partir/arriver sereinement depuis Nice."
      sections={[
        {
        ...
        },
        {
          ...
          bullets: [
            "Routier : flexible pour Europe proche (Italie/Monaco/Suisse).",
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Oui. Avec Moverz, vous pouvez demander 3 devis minimum comparables via un seul dossier, sans engagement.",
        },
        {
