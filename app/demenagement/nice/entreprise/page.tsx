...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement d’entreprise à Nice : transfert de bureaux, informatique, archives. Méthode, minimisation d’arrêt, assurance + 3 à 5 devis comparables via Moverz.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="entreprise"
      badge="B2B"
      h1="Déménagement d’entreprise à Nice"
