...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement pas cher à Nice : leviers concrets (dates, volume, accès/monte-meuble) + 3 à 5 devis comparables et sans spam. Payez moins sans sacrifier la fiabilité.",
});
