...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Location camion déménagement à Marseille : quel volume choisir, prix, conditions (permis, caution), conseils chargement + alternative : comparer des devis comparables pros.",
});
