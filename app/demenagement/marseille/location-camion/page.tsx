...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Location camion déménagement Marseille : volumes, prix & conseils | Moverz",
  description:
    "Location camion déménagement à Marseille : quel volume choisir, prix, conditions (permis, caution), conseils chargement + alternative : comparer 3 à 5 devis pros.",
});
