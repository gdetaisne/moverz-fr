...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Garde-meuble à Marseille : comparer box/self-stockage et solutions avec déménageur. Tarifs, tailles, sécurité, conseils + des devis comparables gratuits via Moverz.",
});
