...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Déménagement d’entreprise à Marseille : transfert bureaux, devis | Moverz",
  description:
    "Déménagement d’entreprise à Marseille : transfert de bureaux, informatique, archives. Méthode, minimisation d’arrêt, assurance + 3 à 5 devis comparables via Moverz.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="entreprise"
      badge="B2B"
      h1="Déménagement d’entreprise à Marseille"
      ...
      sections={[
        ...
        {
          title: "Comparer 3 à 5 devis sur une base identique",
          paragraphs: [
