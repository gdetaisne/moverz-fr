...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Aide au déménagement à Marseille : main d’œuvre, matériel, devis",
  description:
    "Aide au déménagement à Marseille : porteurs, manutention, monte-meuble, matériel. Conseils + des devis comparables comparables pour une aide à la carte, sans spam.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="aide-demenagement"
      badge="À la carte"
      h1="Aide au déménagement à Marseille"
      ...
      sections={[
        {
          ...
          paragraphs: [
            ...
            "À Marseille, la combinaison accès + stationnement peut rendre un renfort utile même pour un petit volume.",
          ],
          bullets: [
