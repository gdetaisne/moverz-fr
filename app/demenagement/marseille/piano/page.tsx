...
export const metadata = generateCityServiceMetadata({
  citySlug: "marseille",
  serviceSlug: "piano",
  title: "Déménagement piano Marseille : transport sécurisé, devis | Moverz",
  description:
    "Déménagement piano à Marseille : piano droit ou à queue, accès, protections, assurance. Conseils + 3 devis minimum de pros pour un transport sécurisé.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="piano"
      badge="Objet lourd"
      h1="Déménagement de piano à Marseille"
      ...
      faqs={[
        {
          question: "Combien coûte un déménagement de piano à Marseille ?",
          answer:
            "Le prix dépend du type de piano, des étages et de l’accès. Un accès simple coûte moins cher qu’un transport avec escalier étroit ou monte-meuble. Le plus fiable est de demander plusieurs devis comparables.",
        },
        {
