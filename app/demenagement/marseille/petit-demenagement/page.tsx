...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Petit déménagement à Marseille : transport petit volume & devis | Moverz",
  description:
    "Petit déménagement à Marseille (petit volume) : options, fourchettes de prix, accès, timing. Comparez 3 devis minimum pros pour transporter quelques meubles/cartons.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="petit-demenagement"
      badge="Petit volume"
      h1="Petit déménagement à Marseille"
      ...
      sections={[
        ...
        {
          title: "Les options les plus efficaces à Marseille",
          paragraphs: [
        ...
        },
        {
          ...
          bullets: [
            "Nombre de pièces + 2–3 photos (salon/chambre).",
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Regardez aussi la page “aide au déménagement à Marseille” : main d’œuvre, matériel et options à la carte.",
        },
      ]}
    />
  );
