...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement pas cher à Marseille : leviers concrets (dates, volume, formule) + des devis comparables comparables et sans spam. Payez moins sans sacrifier la fiabilité.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="pas-cher"
      badge="Budget"
      h1="Déménagement pas cher à Marseille"
      ...
      sections={[
        {
          title: "Ce qui fait varier le prix à Marseille",
          paragraphs: [
            "Le tarif dépend surtout du volume (m³), des accès (étage, ascenseur, stationnement) et de la période (été, week-ends, fin de mois).",
            "À Marseille, les contraintes d’accès et de stationnement peuvent peser autant que la distance : un devis “pas cher” sans détail finit souvent par une surprise.",
          ],
          bullets: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Standard : protection + démontage/remontage + transport (souvent très rentable en effort).",
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Moverz structure le dossier et transmet les mêmes informations complètes à tous pour des devis comparables, sans spam.",
          ],
          bullets: [
      ...
      faqs={[
        {
          question: "Quand déménager moins cher à Marseille ?",
          answer:
        ...
        },
        {
          ...
          answer:
            "Souvent parce que le volume ou les accès sont sous-estimés. Le jour J, ça se transforme en suppléments ou en dégradation de service. Exigez un devis clair et comparable.",
        },
        {
          question: "Le stationnement influence vraiment le prix ?",
          answer:
            "Oui. Si le camion ne peut pas se rapprocher, le portage augmente fortement le temps sur place, donc le coût.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Dans ce cas, regardez aussi la page “petit déménagement à Marseille” : la logique de prix est souvent dominée par les accès et le temps sur place.",
        },
      ]}
    />
  );
