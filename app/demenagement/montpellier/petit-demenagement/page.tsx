...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Petit déménagement à Montpellier (petit volume) : options, fourchettes de prix, accès, timing. Comparez 3 à 5 devis pros pour transporter quelques meubles/cartons.",
});
