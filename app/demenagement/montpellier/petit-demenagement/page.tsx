...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Petit déménagement à Montpellier (petit volume) : options, fourchettes de prix, accès, timing. comparez 5+ devis comparés pros pour transporter quelques meubles/cartons.",
});
