...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Petit déménagement à Montpellier : transport petit volume & devis | Moverz",
  description:
    "Petit déménagement à Montpellier (petit volume) : options, fourchettes de prix, accès, timing. Comparez 3 devis minimum pros pour transporter quelques meubles/cartons.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="petit-demenagement"
      badge="Petit volume"
      h1="Petit déménagement à Montpellier"
      ...
      sections={[
        ...
        {
          title: "Les options les plus efficaces à Montpellier",
          paragraphs: [
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Regardez aussi “aide au déménagement à Montpellier” : main d’œuvre, matériel et options à la carte.",
        },
      ]}
    />
  );
