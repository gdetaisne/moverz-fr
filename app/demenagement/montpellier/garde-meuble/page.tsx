...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Garde-meuble à Montpellier : comparer box/self-stockage et solutions avec déménageur. Tailles, sécurité, assurance, conseils + des devis comparables via Moverz.",
});
