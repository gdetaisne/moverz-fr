...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Aide au déménagement à Montpellier : main d’œuvre, matériel, devis",
  description:
    "Aide au déménagement à Montpellier : porteurs, manutention, monte-meuble, matériel. Conseils + des devis comparables comparables pour une aide à la carte, sans spam.",
});
