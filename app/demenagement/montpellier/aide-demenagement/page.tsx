...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Aide au déménagement à Montpellier : porteurs, manutention, monte-meuble, matériel. Conseils + 5+ devis comparés comparables pour une aide à la carte, sans spam.",
});
