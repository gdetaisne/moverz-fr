...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Location camion déménagement à Montpellier : quel volume choisir, prix, conditions (permis, caution), conseils stationnement + alternative : comparer 5+ devis pros.",
});
