...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Location camion déménagement à Montpellier : quel volume choisir, prix, conditions (permis, caution), conseils stationnement + alternative : comparer des devis comparables pros.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="location-camion"
      badge="DIY"
      h1="Location de camion pour déménagement à Montpellier"
      subtitle="Vous déménagez en autonomie ? Choisir le bon utilitaire (volume, permis), éviter les pièges (assurance, caution) et gérer le stationnement."
      sections={[
        {
          ...
          paragraphs: [
            ...
            "À Montpellier, les accès en centre-ville peuvent compliquer les gros gabarits : un véhicule bien dimensionné est souvent plus simple.",
          ],
          bullets: [
        ...
        {
          title: "Stationnement à Montpellier : à anticiper",
          paragraphs: [
