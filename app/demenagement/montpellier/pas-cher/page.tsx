...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement pas cher à Montpellier : leviers concrets (dates, volume, accès/monte-meuble) + des devis comparables comparables et sans spam. Payez moins sans sacrifier la fiabilité.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="pas-cher"
      badge="Budget"
      h1="Déménagement pas cher à Montpellier"
      subtitle="Montpellier a ses particularités (stationnement, rues du centre, étages) : voici comment réduire le prix intelligemment, sans rogner sur la sécurité."
      sections={[
        {
          title: "Ce qui fait vraiment le prix à Montpellier",
          paragraphs: [
            "Le tarif dépend du volume (m³), des accès (étage, ascenseur, distance de portage) et de la période (été, week-ends, fin de mois).",
            "À Montpellier, l’accès et le stationnement peuvent vite faire monter la facture si ce n’est pas anticipé.",
          ],
          bullets: [
        ...
        {
          title: "Astuces simples pour payer moins à Montpellier",
          paragraphs: [
      ...
      faqs={[
        {
          question: "Quand déménager moins cher à Montpellier ?",
          answer:
        ...
        },
        {
          ...
          answer:
            "Regardez aussi “petit déménagement à Montpellier” : sur petit volume, les accès et le temps sur place font souvent la différence.",
        },
      ]}
    />
  );
