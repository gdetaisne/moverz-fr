...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement pas cher à Montpellier : leviers concrets (dates, volume, accès/monte-meuble) + 5+ devis comparables et sans spam. Payez moins sans sacrifier la fiabilité.",
});
