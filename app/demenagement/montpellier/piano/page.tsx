...
export const metadata = generateCityServiceMetadata({
  ...
  serviceSlug: "piano",
  title: "Déménagement piano Montpellier : transport sécurisé, devis",
  description:
    "Déménagement piano à Montpellier : piano droit ou à queue, accès, protections, assurance. Conseils + des devis comparables de pros pour un transport sécurisé.",
});
