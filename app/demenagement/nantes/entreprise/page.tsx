...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Déménagement d’entreprise à Nantes : transfert bureaux, devis",
  description:
    "Déménagement d’entreprise à Nantes : transfert de bureaux, informatique, archives. Méthode, minimisation d’arrêt, assurance + des devis comparables comparables via Moverz.",
});
