...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Garde-meuble à Nantes : box, stockage, tarifs & devis | Moverz",
  description:
    "Garde-meuble à Nantes : comparer box/self-stockage et solutions avec déménageur. Tailles, sécurité, assurance, conseils + 3 devis minimum via Moverz.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      sections={[
        {
          title: "Quand un garde-meuble est utile à Nantes ?",
          paragraphs: [
            ...
            "À Nantes, c’est aussi très pratique pour lisser les dates (bail, travaux) ou stocker avant/après un déménagement longue distance.",
          ],
          bullets: [
