...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement pas cher à Nantes : leviers concrets (dates, volume, formule) + des devis comparables comparables et sans spam. Payez moins sans sacrifier la fiabilité.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="pas-cher"
      badge="Budget"
      h1="Déménagement pas cher à Nantes"
      ...
      sections={[
        {
          title: "Ce qui fait varier le prix à Nantes",
          paragraphs: [
            "Le tarif dépend surtout du volume (m³), des accès (étage, ascenseur, stationnement) et de la période (été, week-ends, fin de mois).",
            "À Nantes, un devis “pas cher” sans détails (accès, distance de portage, date) finit souvent par une surprise ou une qualité en baisse.",
          ],
          bullets: [
      ...
      faqs={[
        {
          question: "Quand déménager moins cher à Nantes ?",
          answer:
        ...
        },
        {
          ...
          answer:
            "Regardez aussi la page “petit déménagement à Nantes” : sur petit volume, l’accès et le temps sur place font souvent la différence.",
        },
      ]}
    />
  );
