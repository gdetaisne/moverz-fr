...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Location camion déménagement Nantes : volumes, prix & conseils",
  description:
    "Location camion déménagement à Nantes : quel volume choisir, prix, conditions (permis, caution), conseils stationnement + alternative : comparer des devis comparables pros.",
});
