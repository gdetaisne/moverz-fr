...
export const metadata = generateCityServiceMetadata({
  citySlug: "nantes",
  serviceSlug: "piano",
  title: "Déménagement piano Nantes : transport sécurisé, devis",
  description:
    "Déménagement piano à Nantes : piano droit ou à queue, accès, protections, assurance. Conseils + des devis comparables de pros pour un transport sécurisé.",
});
