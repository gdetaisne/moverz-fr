...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Aide au déménagement à Nantes : main d’œuvre, matériel, devis",
  description:
    "Aide au déménagement à Nantes : porteurs, manutention, monte-meuble, matériel. Conseils + des devis comparables comparables pour une aide à la carte, sans spam.",
});
