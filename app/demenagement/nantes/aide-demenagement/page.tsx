...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Aide au déménagement à Nantes : main d’œuvre, matériel, devis | Moverz",
  description:
    "Aide au déménagement à Nantes : porteurs, manutention, monte-meuble, matériel. Conseils + 3 devis minimum comparables pour une aide à la carte, sans spam.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="aide-demenagement"
      badge="À la carte"
      h1="Aide au déménagement à Nantes"
      ...
      sections={[
        {
          ...
          paragraphs: [
            ...
            "À Nantes, les accès et le stationnement en centre-ville peuvent rendre un renfort utile même pour un petit volume.",
          ],
          bullets: [
