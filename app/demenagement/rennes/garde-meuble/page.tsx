...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Garde-meuble à Rennes : box, stockage, tarifs & devis",
  description:
    "Garde-meuble à Rennes : comparer box/self-stockage et solutions avec déménageur. Tailles, sécurité, assurance, conseils + des devis comparables via Moverz.",
});
