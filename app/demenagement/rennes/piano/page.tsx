...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement piano à Rennes : piano droit ou à queue, accès, protections, assurance. Conseils + des devis comparables de pros pour un transport sécurisé.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="piano"
      badge="Objet lourd"
      h1="Déménagement de piano à Rennes"
      ...
      faqs={[
        {
          question: "Combien coûte un déménagement de piano à Rennes ?",
          answer:
