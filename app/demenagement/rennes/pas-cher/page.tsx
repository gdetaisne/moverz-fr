...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Déménagement pas cher à Rennes : astuces + devis comparables",
  description:
    "Déménagement pas cher à Rennes : leviers concrets (dates, volume, formule) + des devis comparables comparables et sans spam. Payez moins sans sacrifier la fiabilité.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="pas-cher"
      badge="Budget"
      h1="Déménagement pas cher à Rennes"
      ...
      sections={[
        {
          title: "Ce qui fait varier le prix à Rennes",
          paragraphs: [
            "Le tarif dépend surtout du volume (m³), des accès (étage, ascenseur, stationnement) et de la période (été, week-ends, fin de mois).",
            "À Rennes, un devis “pas cher” sans détails (accès, distance de portage, date) finit souvent par une surprise ou une qualité en baisse.",
          ],
          bullets: [
      ...
      faqs={[
        {
          question: "Quand déménager moins cher à Rennes ?",
          answer:
        ...
        {
          question: "Quelles aides peuvent exister pour déménager ?",
          answer:
            "Selon votre situation, des aides peuvent être mobilisées (CAF, Action Logement, FSL…). Vérifiez toujours les critères officiels et les délais de demande.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Regardez aussi la page “petit déménagement à Rennes” : sur petit volume, l’accès et le temps sur place font souvent la différence.",
        },
      ]}
    />
  );
