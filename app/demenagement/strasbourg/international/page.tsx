...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement international depuis/vers Strasbourg : Europe, Allemagne, formalités, assurance, stockage. Conseils + des devis comparables comparables via Moverz.",
});
