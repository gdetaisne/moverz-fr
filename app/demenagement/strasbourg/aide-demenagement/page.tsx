...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Aide au déménagement à Strasbourg : main d’œuvre, matériel, devis",
  description:
    "Aide au déménagement à Strasbourg : porteurs, manutention, monte-meuble, matériel. Conseils + des devis comparables comparables pour une aide à la carte, sans spam.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="aide-demenagement"
      badge="À la carte"
      h1="Aide au déménagement à Strasbourg"
      ...
      sections={[
        {
          ...
          paragraphs: [
            ...
            "À Strasbourg, centre-ville, rues étroites et immeubles anciens peuvent rendre un renfort utile même pour un petit volume.",
          ],
          bullets: [
