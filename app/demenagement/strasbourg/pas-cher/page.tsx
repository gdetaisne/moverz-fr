...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement pas cher à Strasbourg : leviers concrets (dates, volume, formule) + 5+ devis comparés comparables et sans spam. Payez moins sans sacrifier la fiabilité.",
});
