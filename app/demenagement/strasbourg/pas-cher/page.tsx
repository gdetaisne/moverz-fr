...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement pas cher à Strasbourg : leviers concrets (dates, volume, formule) + des devis comparables comparables et sans spam. Payez moins sans sacrifier la fiabilité.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="pas-cher"
      badge="Budget"
      h1="Déménagement pas cher à Strasbourg"
      ...
      sections={[
        {
          title: "Ce qui fait varier le prix à Strasbourg",
          paragraphs: [
            "Le tarif dépend surtout du volume (m³), des accès (étage, ascenseur, portage) et de la période (été, rentrée, week-ends, fin de mois).",
            "À Strasbourg, les zones denses et parfois piétonnes rendent l’accès et le stationnement déterminants : un devis “pas cher” sans détails finit souvent par une surprise.",
          ],
          bullets: [
      ...
      faqs={[
        {
          question: "Quand déménager moins cher à Strasbourg ?",
          answer:
            "Les jours de semaine et les périodes creuses sont souvent plus abordables. L’été, la rentrée et fin de mois sont plus demandés, donc plus chers.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Regardez aussi la page “petit déménagement à Strasbourg” : sur petit volume, l’accès et le temps sur place font souvent la différence.",
        },
      ]}
    />
  );
