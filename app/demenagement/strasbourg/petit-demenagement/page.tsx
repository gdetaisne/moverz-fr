...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Petit déménagement à Strasbourg (petit volume) : options, fourchettes de prix, accès, timing. comparez 5+ devis comparés pros pour transporter quelques meubles/cartons.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="petit-demenagement"
      badge="Petit volume"
      h1="Petit déménagement à Strasbourg"
      ...
      sections={[
        {
          ...
          bullets: [
            "Idéal pour studio/colocation (fréquent autour des quartiers étudiants).",
            "Souvent compatible avec des créneaux plus flexibles.",
            "Bonne alternative à la location d’utilitaire + stress logistique.",
          ],
        },
        {
          title: "Les options les plus efficaces à Strasbourg",
          paragraphs: [
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Regardez aussi la page “aide au déménagement à Strasbourg” : main d’œuvre, matériel et options à la carte.",
        },
      ]}
    />
  );
