...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Location camion déménagement à Strasbourg : quel volume choisir, prix, conditions (permis, caution), conseils centre-ville/tram + alternative : comparer 3 à 5 devis pros.",
});
