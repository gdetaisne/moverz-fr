...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement pas cher à Toulouse : leviers concrets (dates, volume, formule) + 3 devis minimum comparables et sans spam. Conseils pour payer moins sans sacrifier la fiabilité.",
});
