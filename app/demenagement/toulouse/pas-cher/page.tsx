...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement pas cher à Toulouse : leviers concrets (dates, volume, formule) + 5+ devis comparables et sans spam. Conseils pour payer moins sans sacrifier la fiabilité.",
});
