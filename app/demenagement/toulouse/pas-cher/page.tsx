...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Déménagement pas cher à Toulouse : astuces + devis comparables",
  description:
    "Déménagement pas cher à Toulouse : leviers concrets (dates, volume, formule) + des devis comparables comparables et sans spam. Conseils pour payer moins sans sacrifier la fiabilité.",
});
