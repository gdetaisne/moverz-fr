...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Petit déménagement à Toulouse : transport petit volume & devis",
  description:
    "Petit déménagement à Toulouse (petit volume) : options, fourchettes de prix, accès, timing. Comparez 3 devis minimum pros pour transporter quelques meubles/cartons.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="petit-demenagement"
      badge="Petit volume"
      h1="Petit déménagement à Toulouse"
      subtitle="Quelques meubles, un studio, une colocation ? Voici les meilleures options pour un petit volume : rapide, économique, et sans mauvaise surprise."
      sections={[
        {
          ...
          bullets: [
            ...
            "Parfait si vous voulez éviter une location d’utilitaire + stress logistique.",
          ],
        },
        {
          title: "Les options les plus efficaces à Toulouse",
          paragraphs: [
            "Pour un petit volume, l’objectif est d’éviter de payer “comme un gros déménagement”, tout en gardant un service fiable.",
            "Comparer plusieurs devis permet souvent de trouver un bon créneau et un prix juste, surtout si vous êtes flexible sur la date.",
          ],
          bullets: [
            "Formule économique : vous emballez, les pros transportent.",
            "Déménagement groupé/optimisé : si le prestataire combine plusieurs trajets (selon période).",
        ...
        },
        {
          ...
          paragraphs: [
            "Sur un petit déménagement, ce qui fait exploser le budget, c’est souvent le temps perdu : stationnement compliqué, portage long, meubles pas prêts, démontage non anticipé.",
          ...
          bullets: [
            ...
            "Démontez les meubles simples (si vous savez le faire) et mettez la visserie en sachet.",
      ...
      faqs={[
        {
          ...
          answer:
            "Oui, si le volume est faible et l’accès simple (rez-de-chaussée, stationnement facile). Avec un étage sans ascenseur, le temps peut vite augmenter.",
        },
        {
          question: "Est-ce moins cher que louer un camion ?",
          answer:
            "Parfois oui, surtout si vous valorisez votre temps et évitez les imprévus (caution, assurance, stationnement, fatigue). Demander des devis permet de trancher objectivement.",
        },
        {
          question: "Je transporte seulement 2–3 meubles : ça vaut le coup ?",
          answer:
            "Oui, notamment si les meubles sont lourds/fragiles ou si l’accès est compliqué. Le prix dépendra surtout du temps de manutention.",
        },
        {
          question: "Comment éviter les suppléments le jour J ?",
          answer:
            "Donnez un volume réaliste, décrivez précisément les accès, et préparez tout en amont (emballage, démontage). Les surprises viennent souvent d’un volume sous-estimé ou d’un accès non mentionné.",
        },
        {
          question: "Puis-je comparer plusieurs devis gratuitement ?",
          answer:
            "Oui. Avec Moverz, vous remplissez un seul dossier et recevez 3 devis minimum standardisés, sans engagement.",
        },
        {
          question: "Et si j’ai surtout besoin d’un coup de main (portage) ?",
          answer:
            "Dans ce cas, regardez aussi notre page “aide au déménagement à Toulouse” : elle couvre main d’œuvre, monte-meuble et services à la carte.",
        },
      ]}
    />
  );
