...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Garde-meuble à Toulouse : comparer box/self-stockage et solutions avec déménageur. Tarifs, tailles, sécurité, conseils + des devis comparables gratuits via Moverz.",
});
