...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Location camion déménagement à Bordeaux : quel volume choisir, prix, conditions (permis, caution), conseils centre-ville/quais + alternative : comparer 5+ devis comparés pros.",
});
