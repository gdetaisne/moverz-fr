...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Location camion déménagement à Bordeaux : quel volume choisir, prix, conditions (permis, caution), conseils centre-ville/quais + alternative : comparer des devis comparables pros.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="location-camion"
      badge="DIY"
      h1="Location de camion pour déménagement à Bordeaux"
      subtitle="Vous voulez déménager en autonomie ? Choisir le bon utilitaire (volume, permis), éviter les pièges (assurance, caution) et gérer les contraintes du centre/quais."
      sections={[
        {
        ...
        {
          title: "Accès et stationnement à Bordeaux : le point sous-estimé",
          paragraphs: [
