...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Petit déménagement à Bordeaux : transport petit volume & devis | Moverz",
  description:
    "Petit déménagement à Bordeaux (petit volume) : options, fourchettes de prix, accès, timing. Comparez 3 devis minimum pros pour transporter quelques meubles/cartons.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="petit-demenagement"
      badge="Petit volume"
      h1="Petit déménagement à Bordeaux"
      ...
      sections={[
        ...
        {
          title: "Les options les plus efficaces à Bordeaux",
          paragraphs: [
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Regardez aussi la page “aide au déménagement à Bordeaux” : main d’œuvre, matériel et options à la carte.",
        },
      ]}
    />
  );
