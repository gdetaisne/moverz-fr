...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Aide au déménagement à Bordeaux : main d’œuvre, matériel, devis",
  description:
    "Aide au déménagement à Bordeaux : porteurs, manutention, monte-meuble, matériel. Conseils + des devis comparables comparables pour une aide à la carte, sans spam.",
});
...
export default function Page() {
  return (
    <CityServicePage
      ...
      serviceSlug="aide-demenagement"
      badge="À la carte"
      h1="Aide au déménagement à Bordeaux"
      ...
      sections={[
        {
          ...
          paragraphs: [
            ...
            "À Bordeaux, les accès (escaliers, immeubles anciens) et le stationnement peuvent rendre un renfort utile même pour un petit volume.",
          ],
          bullets: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Moverz structure votre demande et transmet les mêmes informations à tous pour recevoir des propositions comparables.",
          ],
          bullets: [
