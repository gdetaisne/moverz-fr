...
export const metadata = generateCityServiceMetadata({
  ...
  title: "Aide au déménagement à Bordeaux : main d’œuvre, matériel, devis | Moverz",
  description:
    "Aide au déménagement à Bordeaux : porteurs, manutention, monte-meuble, matériel. Conseils + 3 devis minimum comparables pour une aide à la carte, sans spam.",
});
