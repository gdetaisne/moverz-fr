...
export const metadata = generateCityServiceMetadata({
  ...
  description:
    "Déménagement d’entreprise à Bordeaux : transfert de bureaux, informatique, archives. Méthode, minimisation d’arrêt, assurance + 5+ devis comparés comparables via Moverz.",
});
