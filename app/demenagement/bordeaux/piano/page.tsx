...
export const metadata = generateCityServiceMetadata({
  citySlug: "bordeaux",
  serviceSlug: "piano",
  title: "Déménagement piano Bordeaux : transport sécurisé, devis",
  description:
    "Déménagement piano à Bordeaux : piano droit ou à queue, accès, protections, assurance. Conseils + des devis comparables de pros pour un transport sécurisé.",
});
