...
export default function Page() {
  return (
    <QuartierPage
      ...
      description="Service professionnel de déménagement dans le quartier Jean-Jaurès"
      stats={{
        dossiers: "+45",
        demenageurs: "15",
        delai: "3-5"
      }}
      pourquoiMoverz="Jean-Jaurès est un quartier prisé de Toulouse. Nos déménageurs spécialisés connaissent parfaitement les contraintes d'accès et s'adaptent aux particularités du quartier."
      accesStationnement="Jean-Jaurès présente des contraintes d'accès spécifiques. Nos partenaires déménageurs maîtrisent les créneaux autorisés, les zones de déchargement et optimisent les horaires."
