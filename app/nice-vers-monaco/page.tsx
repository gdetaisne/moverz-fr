...
export default function Page() {
  return (
    <CorridorPage
      ...
      accesArrivee="Monaco présente des défis spécifiques pour les déménagements. Nos partenaires déménageurs connaissent parfaitement les contraintes locales."
      conseils={[
      ...
      faq={[
        {
          question: "Quels sont les délais pour un déménagement Nice → Monaco ?",
        ...
        {
          question: "Quels sont les tarifs pour Nice → Monaco ?",
