...
export default function Page() {
  return (
    <QuartierPage
      ...
      quartierSlug="cimiez"
      quartierName="Cimiez"
      description="Comparer des déménageurs vérifiés pour le quartier cimiez"
      stats={{
        dossiers: "+45",
        demenageurs: "15",
        delai: "3-5"
      }}
      pourquoiMoverz="Cimiez est un quartier prisé de Nice. Les déménageurs partenaires Moverz connaissent les contraintes d'accès de ce quartier et s'y adaptent."
      accesStationnement="Cimiez présente des contraintes d'accès spécifiques. Les déménageurs partenaires sélectionnés par Moverz maîtrisent les créneaux autorisés et les zones de déchargement de ce quartier."
