...
export default function Page() {
  return (
    <CorridorPage
      ...
      accesArrivee="Le Havre présente des défis spécifiques pour les déménagements. Nos partenaires déménageurs connaissent parfaitement les contraintes locales."
      conseils={[
      ...
      faq={[
        {
          question: "Quels sont les délais pour un déménagement Rouen → Le Havre ?",
        ...
        {
          question: "Quels sont les tarifs pour Rouen → Le Havre ?",
