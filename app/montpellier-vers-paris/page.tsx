...
export default function Page() {
  return (
    <CorridorPage
      ...
      accesArrivee="Paris présente des défis spécifiques pour les déménagements. Nos partenaires déménageurs connaissent parfaitement les contraintes locales."
      conseils={[
      ...
      faq={[
        {
          question: "Quels sont les délais pour un déménagement Montpellier → Paris ?",
        ...
        {
          question: "Quels sont les tarifs pour Montpellier → Paris ?",
