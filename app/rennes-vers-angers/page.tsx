...
export default function Page() {
  return (
    <CorridorPage
      ...
      accesArrivee="Angers présente des défis spécifiques pour les déménagements. Nos partenaires déménageurs connaissent parfaitement les contraintes locales."
      conseils={[
      ...
      faq={[
        {
          question: "Quels sont les délais pour un déménagement Rennes → Angers ?",
        ...
        {
          question: "Quels sont les tarifs pour Rennes → Angers ?",
