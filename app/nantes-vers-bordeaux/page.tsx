...
export default function Page() {
  return (
    <CorridorPage
      ...
      accesArrivee="Bordeaux présente des défis spécifiques pour les déménagements. Nos partenaires déménageurs connaissent parfaitement les contraintes locales."
      conseils={[
      ...
      faq={[
        {
          question: "Quels sont les délais pour un déménagement Nantes → Bordeaux ?",
        ...
        {
          question: "Quels sont les tarifs pour Nantes → Bordeaux ?",
