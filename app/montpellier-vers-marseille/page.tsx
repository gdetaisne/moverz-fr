...
export default function Page() {
  return (
    <CorridorPage
      ...
      accesArrivee="Marseille présente des défis spécifiques pour les déménagements. Nos partenaires déménageurs connaissent parfaitement les contraintes locales."
      conseils={[
      ...
      faq={[
        {
          question: "Quels sont les délais pour un déménagement Montpellier → Marseille ?",
        ...
        {
          question: "Quels sont les tarifs pour Montpellier → Marseille ?",
