    ...
    <main className="bg-hero min-h-screen">
      ...
      <section className="section section-light">
        <div className="container max-w-4xl space-y-10">
          {!hasQuery ? (
            <div className="rounded-2xl border border-[#E3E5E8] bg-white p-6 text-sm text-[#4b5c6b]">
          ...
          {cityResults.length > 0 ? (
            <div className="space-y-3">
              <h2 className="text-lg md:text-xl font-semibold text-[#04163a]">Villes</h2>
          ...
          {blogResults.length > 0 ? (
            <div className="space-y-3">
              <h2 className="text-lg md:text-xl font-semibold text-[#04163a]">Articles</h2>
              <div className="space-y-3">
                {blogResults.map((post) => (
                  ...
                  >
                    ...
                    <p className="text-base font-semibold text-[#04163a] group-hover:text-[#2B7A78]">
                      {post.title}
                    </p>
