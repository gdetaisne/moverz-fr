      ...
      <section className="relative overflow-hidden text-white">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          ...
          <p className="text-white/85 mt-3 max-w-3xl">
            Vos données personnelles sont importantes. Découvrez comment Moverz les collecte, les utilise et les protège.
          </p>
        </div>
      </section>
        ...
        <div className="container max-w-5xl">
          <div className="space-y-10 text-white/90">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <h2 className="text-2xl font-semibold text-white mb-3">1. Collecte des données personnelles</h2>
              <p>
                Moverz collecte des données personnelles lorsque vous utilisez notre service de comparaison de devis de déménagement.
              </p>
              <ul className="list-disc pl-6 mt-3 space-y-1 text-white/80">
                ...
                <li>Informations sur le déménagement (adresses, date, volume estimé, services requis).</li>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              ...
              <ul className="list-disc pl-6 mt-3 space-y-1 text-white/80">
                <li>Vous fournir le service de comparaison de devis</li>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <h2 className="text-2xl font-semibold text-white mb-3">3. Vos droits RGPD</h2>
              ...
              <p className="mt-4">
                Contact RGPD : <span className="underline">contact@moverz.fr</span>
              </p>
            </div>

            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <h2 className="text-2xl font-semibold text-white mb-3">4. Sécurité des données</h2>
              <p>
