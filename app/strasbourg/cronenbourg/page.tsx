...
export default function Page() {
  return (
    <QuartierPage
      ...
      description="Comparer des déménageurs vérifiés pour le quartier cronenbourg"
      stats={{
        dossiers: "+45",
        demenageurs: "15",
        delai: "3-5"
      }}
      pourquoiMoverz="Cronenbourg est un quartier prisé de Strasbourg. Les déménageurs partenaires Moverz connaissent les contraintes d'accès de ce quartier et s'y adaptent."
      accesStationnement="Cronenbourg présente des contraintes d'accès spécifiques. Les déménageurs partenaires sélectionnés par Moverz maîtrisent les créneaux autorisés et les zones de déchargement de ce quartier."
