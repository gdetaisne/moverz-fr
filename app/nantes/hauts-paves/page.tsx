...
export default function Page() {
  return (
    <QuartierPage
      ...
      description="Comparer des déménageurs vérifiés pour le quartier hauts-paves"
      stats={{
        dossiers: "+45",
        demenageurs: "15",
        delai: "3-5"
      }}
      pourquoiMoverz="Hauts-Pavés est un quartier prisé de Nantes. Les déménageurs partenaires Moverz connaissent les contraintes d'accès de ce quartier et s'y adaptent."
      accesStationnement="Hauts-Pavés présente des contraintes d'accès spécifiques. Les déménageurs partenaires sélectionnés par Moverz maîtrisent les créneaux autorisés et les zones de déchargement de ce quartier."
