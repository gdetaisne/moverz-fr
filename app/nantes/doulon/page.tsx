...
export default function Page() {
  return (
    <QuartierPage
      ...
      quartierSlug="doulon"
      quartierName="Doulon"
      description="Service professionnel de déménagement dans le quartier Doulon"
      stats={{
        dossiers: "+45",
        demenageurs: "15",
        delai: "3-5"
      }}
      pourquoiMoverz="Doulon est un quartier prisé de Nantes. Nos déménageurs spécialisés connaissent parfaitement les contraintes d'accès et s'adaptent aux particularités du quartier."
      accesStationnement="Doulon présente des contraintes d'accès spécifiques. Nos partenaires déménageurs maîtrisent les créneaux autorisés, les zones de déchargement et optimisent les horaires."
