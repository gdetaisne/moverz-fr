...
export default function Page() {
  return (
    <CorridorPage
      ...
      accesArrivee="Amiens présente des défis spécifiques pour les déménagements. Nos partenaires déménageurs connaissent parfaitement les contraintes locales."
      conseils={[
      ...
      faq={[
        {
          question: "Quels sont les délais pour un déménagement Rouen → Amiens ?",
        ...
        {
          question: "Quels sont les tarifs pour Rouen → Amiens ?",
