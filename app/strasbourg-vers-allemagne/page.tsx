...
export default function Page() {
  return (
    <CorridorPage
      ...
      accesArrivee="Allemagne présente des défis spécifiques pour les déménagements. Nos partenaires déménageurs connaissent parfaitement les contraintes locales."
      conseils={[
      ...
      faq={[
        {
          question: "Quels sont les délais pour un déménagement Strasbourg → Allemagne ?",
        ...
        {
          question: "Quels sont les tarifs pour Strasbourg → Allemagne ?",
