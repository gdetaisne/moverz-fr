...
export default function CriteresChoisirDemenageurPage() {
  ...
  const guides = [
    ...
    { href: "/blog/verifier-demenageur-creditsafe-siren/", Icon: ShieldCheck, iconColor: "text-blue-600", iconBg: "bg-blue-50", title: "Vérifier un déménageur", desc: "SIREN, Pappers, assurance RC Pro — le guide complet pour ne pas se faire avoir." },
