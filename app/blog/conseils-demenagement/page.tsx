...
export const metadata: Metadata = getFullMetadata(
  "blog/conseils-demenagement",
  "Conseils déménagement : organisation, erreurs à éviter | Moverz",
  "Tous nos conseils pratiques pour préparer votre déménagement : organisation, erreurs à éviter, matériel, enfants, timing et astuces pour déménager serein."
);
      ...
      <section className="relative overflow-hidden text-white">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 space-y-6">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold">
            Conseils pour préparer votre déménagement
          </h1>
          <p className="text-lg md:text-xl text-white/85 max-w-3xl leading-relaxed">
            Organisation, erreurs à éviter, enfants, matériel, volume… retrouvez tous nos
            articles pour déménager plus sereinement.
          </p>
        </div>
      </section>
