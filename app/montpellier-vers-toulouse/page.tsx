...
export const metadata = generateCorridorMetadata('montpellier', 'Montpellier', 'Toulouse');
...
export default function Page() {
  return (
    <CorridorPage
      ...
      accesArrivee="Toulouse présente des défis spécifiques pour les déménagements. Nos partenaires déménageurs connaissent parfaitement les contraintes locales."
      conseils={[
      ...
      faq={[
        {
          question: "Quels sont les délais pour un déménagement Montpellier → Toulouse ?",
        ...
        {
          question: "Quels sont les tarifs pour Montpellier → Toulouse ?",
