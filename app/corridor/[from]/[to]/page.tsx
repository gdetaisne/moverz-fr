...
export function generateMetadata({ params }: PageProps): Metadata {
  ...
  const description = `Déménagement ${from.nameCapitalized} vers ${to.nameCapitalized} : devis gratuits, prix indicatifs, conseils d'experts. déménageurs contrôlés contrôlés · 0€ · Sans démarchage`;
