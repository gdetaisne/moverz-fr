  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        "• <strong>Quartier difficile</strong> : Grande Île (+150-250€)",
        "• <strong>Période à ÉVITER ABSOLUMENT</strong> : Décembre (Marché de Noël = ville paralysée)",
        "• <strong>Autorisation stationnement</strong> : Grande Île obligatoire (délai 7-10j)",
        "• <strong>Anticipation</strong> : 2-3 semaines, 6 semaines si décembre (mais évitez vraiment)",
        "",
        "Strasbourg est efficace et organisée. Profitez de cette qualité alsacienne.",
      ],
    },
  ],
  neighborhoods: [
...
export const MONTPELLIER_PREMIUM_GUIDE: PremiumCityGuideData = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        "• <strong>Prix moyen T2</strong> : 630-970€",
        "• <strong>Quartiers faciles</strong> : Antigone, Port Marianne, Odysseum (pas de surcoût)",
        ...
        "",
        "Montpellier est accessible et agréable pour déménager.",
      ],
    },
  ],
  neighborhoods: [
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        "• <strong>Quartiers faciles</strong> : Lac, Bassins à flot, Chartrons (pas de surcoût)",
        "• <strong>Quartier moyen</strong> : Centre historique UNESCO (+100-180€)",
        "• <strong>Période à anticiper</strong> : Septembre (rentrée)",
        "• <strong>Autorisation</strong> : Centre (40€, 7j)",
        "• <strong>Anticipation</strong> : 2-3 semaines, 4 semaines en septembre",
      ],
    },
  ],
...
export const LILLE_PREMIUM_GUIDE: PremiumCityGuideData = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        "• <strong>Prix moyen T2</strong> : 630-970€",
        "• <strong>Quartiers faciles</strong> : Euralille, Fives, Vauban (pas de surcoût)",
        "• <strong>Quartier moyen</strong> : Vieux-Lille (+100-150€)",
        "• <strong>Date à ÉVITER ABSOLUMENT</strong> : 1er week-end septembre (Braderie = ville fermée)",
        ...
        "",
        "Lille est efficace, organisée, et les déménageurs nordistes sont professionnels.",
      ],
    },
  ],
  neighborhoods: [
...
export const RENNES_PREMIUM_GUIDE: PremiumCityGuideData = {
  ...
  sections: [
    ...
    {
      id: "quartiers-rennes",
      title: "Quartiers Rennes : tous accessibles",
      content: [
        "<strong>Centre historique</strong>",
        "• Rues médiévales (rue Saint-Georges, rue Saint-Michel)",
        "• Immeubles anciens, certains sans ascenseur",
        "• Place des Lices (marché samedi)",
...
export const REIMS_PREMIUM_GUIDE: PremiumCityGuideData = {
  ...
  sections: [
    ...
    {
      id: "centre-cathedrale",
      title: "Centre et cathédrale Notre-Dame : patrimoine UNESCO",
      content: [
        "Le centre de Reims (autour de la cathédrale Notre-Dame, classée UNESCO) a quelques rues étroites médiévales.",
        "",
        "<strong>Contraintes</strong> : Rues étroites (rue de Vesle, rue Carnot), circulation dense, immeubles anciens.",
        "<strong>Solution</strong> : Autorisation si proche cathédrale, arrivée tôt.",
...
export const SAINT_ETIENNE_PREMIUM_GUIDE: PremiumCityGuideData = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: "Quartiers Saint-Étienne : tous faciles",
      content: [
        "<strong>Centre-ville</strong> : Quelques rues étroites, mais gérable. +50-80€.",
        "<strong>Quartiers résidentiels</strong> : Châteaucreux, Bellevue, Montaud. Tous accessibles.",
        "",
        "Saint-Étienne n'a pas de quartier vraiment difficile. C'est une ville simple.",
      ],
    },
    {
      ...
      content: [
        "• <strong>Prix moyen T2</strong> : 540-830€ (les moins chers)",
        "• <strong>Quartiers</strong> : Tous faciles",
        "• <strong>Alternative Lyon</strong> : 30min train, prix -20-30%",
...
export const TOULON_PREMIUM_GUIDE: PremiumCityGuideData = {
  ...
  sections: [
    ...
    {
      id: "quartiers-toulon",
      title: "Quartiers Toulon",
      content: [
        "<strong>Centre-ville / Port</strong> : Circulation dense (marine nationale), rues moyennes. +70-100€.",
        "<strong>Mont Faron</strong> : Colline 584m, pentes, villas, routes en lacets. +100-180€.",
        "<strong>La Valette / Le Mourillon</strong> : Quartiers résidentiels Est, plages, accès faciles. Pas de surcoût.",
      ],
    },
    {
      ...
      content: [
        "• <strong>Prix moyen T2</strong> : 630-970€",
        "• <strong>Quartiers faciles</strong> : La Valette, Le Mourillon (pas de surcoût)",
        "• <strong>Quartiers moyens</strong> : Centre (+70-100€), Mont Faron (+100-180€)",
        "• <strong>Période à éviter</strong> : Plein été (chaleur, vacanciers, +15-20%)",
        "• <strong>Anticipation</strong> : 2-3 semaines",
      ],
    },
  ],
...
export const GRENOBLE_PREMIUM_GUIDE: PremiumCityGuideData = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: "Quartiers Grenoble",
      content: [
        "<strong>Centre historique</strong> : Rues médiévales, mais gérable. +80-120€.",
        "<strong>Europole / Presqu'île</strong> : Quartiers modernes années 1990-2020, très accessibles. Pas de surcoût.",
        "<strong>Quartiers résidentiels</strong> : Tous faciles (ville plate).",
      ],
    },
    {
      ...
      content: [
        "• <strong>Prix moyen T2</strong> : 610-940€",
        "• <strong>Quartiers faciles</strong> : Europole, Presqu'île, quartiers résidentiels",
        "• <strong>Centre historique</strong> : +80-120€",
        "• <strong>Période à anticiper</strong> : Septembre (rentrée scientifique 60 000 étudiants)",
        "• <strong>Anticipation</strong> : 2-3 semaines",
        "",
...
export const DIJON_PREMIUM_GUIDE: PremiumCityGuideData = {
  ...
  sections: [
    ...
    {
      id: "quartiers-dijon",
      title: "Quartiers Dijon",
      content: [
        "<strong>Centre historique (secteur sauvegardé)</strong> : Palais des Ducs, rues étroites, patrimoine. +70-100€.",
        "<strong>Quartiers résidentiels</strong> : Tous faciles, immeubles modernes, larges rues.",
      ],
    },
    {
      ...
      content: [
        "• <strong>Prix moyen T2</strong> : 580-890€",
        "• <strong>Quartiers faciles</strong> : Tous sauf centre",
...
export const ANGERS_PREMIUM_GUIDE: PremiumCityGuideData = {
  ...
  hero: { title: "Déménager à Angers : douceur de la Loire", subtitle: "Ville accessible, prix doux, zéro stress", catchphrase: "Angers, c'est la Loire, la douceur angevine, et des déménagements qui se passent bien." },
  localData: {
    averagePrices: { studio: "340€ - 560€", t2: "580€ - 890€", t3: "890€ - 1330€", t4plus: "1330€ - 2000€" },
    peakSeasons: ["Septembre (rentrée universitaire 40 000 étudiants)"],
    typicalDuration: "3-5h pour un T2",
    parkingChallenges: ["Centre-ville : rues moyennes autour château"],
    municipalRegulations: [],
  },
  sections: [
    {
      ...
      content: [
        "Angers (150 000 habitants), ville de la Loire et du château médiéval, est accessible et agréable pour déménager. Peu de contraintes majeures.",
        "",
        "65+ déménagements suivis. Ville étudiante (40 000 étudiants, université, écoles) et qualité de vie reconnue. Déménagements fluides.",
        "",
        "Angers, c'est la douceur de vivre ligérienne. Les déménageurs angevins sont professionnels et sympathiques.",
      ],
    },
    {
      id: "prix-angers",
      ...
      content: [
        ...
        "<strong>Studio</strong> : 340-560€<br/><strong>T2</strong> : 580-890€<br/><strong>T3</strong> : 890-1330€<br/><strong>T4+</strong> : 1330-2000€",
        "",
        "Prix compétitifs, similaires à Dijon, Reims. Très abordables. Centre château : +50-80€.",
      ],
      tips: [
        "Prix 25-30% moins chers que Paris",
        "Ville de la Loire = douceur de vivre",
        "Proche Nantes (1h) : déménageurs font souvent les deux villes",
      ],
    },
    {
      id: "quartiers-angers",
      title: "Quartiers Angers",
      content: [
        "<strong>Centre-ville / Château</strong> : Rues moyennes autour château d'Angers (forteresse médiévale). +50-80€.",
        "<strong>Quartiers résidentiels</strong> : Belle-Beille, Lac de Maine, Monplaisir. Tous faciles.",
      ],
    },
    {
      ...
      content: [
        "• <strong>Prix moyen T2</strong> : 580-890€",
        "• <strong>Quartiers</strong> : Tous faciles",
        "• <strong>Centre château</strong> : +50-80€",
        "• <strong>Anticipation</strong> : 2 semaines",
        "",
        "Angers = douceur angevine + déménagements tranquilles.",
      ],
    },
  ],
  neighborhoods: [
...
export const NIMES_PREMIUM_GUIDE: PremiumCityGuideData = {
  ...
  sections: [
    ...
    {
      id: "ferias-nimes",
      title: "Férias de Nîmes : les 2 week-ends à éviter",
      content: [
        "Nîmes a 2 Férias majeures dans l'année :",
        "",
        "<strong>Féria de Pentecôte (mai)</strong> : Week-end de Pentecôte, 1 million de visiteurs, corridas aux arènes, bodégas partout.",
        "<strong>Féria des Vendanges (septembre)</strong> : 3ème week-end septembre, même ampleur.",
        "",
...
export const VILLEURBANNE_PREMIUM_GUIDE: PremiumCityGuideData = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        "Le quartier des Gratte-Ciel, c'est l'emblème de Villeurbanne. Construit années 1930 (architecture Art Déco), modernisé 2000-2020.",
        "",
        "• Métro A et B (Charpennes)",
        "• Immeubles Art Déco rénovés avec ascenseurs",
