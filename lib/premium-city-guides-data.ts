  ...
  sections: [
    {
      ...
      content: [
        "Dijon, capitale de Bourgogne, combine patrimoine (Palais des Ducs, secteur sauvegardé) et accessibilité moderne.",
        "60+ déménagements suivis. Ville de taille humaine (160 000 habitants), bien organisée. Centre historique : +70-100€.",
      ],
    },
    {
      id: "prix-dijon",
      ...
      content: [
        "<strong>Studio</strong> : 340-560€<br/><strong>T2</strong> : 580-890€<br/><strong>T3</strong> : 890-1330€<br/><strong>T4+</strong> : 1330-2000€",
        "Prix compétitifs, similaires à Reims. Centre : +70-100€.",
      ],
    },
  ],
  neighborhoods: [
...
export const ANGERS_PREMIUM_GUIDE: PremiumCityGuideData = {
  ...
  sections: [
    {
      id: "angers-loire",
      title: "Angers : douceur et simplicité",
      content: [
        "Angers, ville de la Loire (150 000 habitants), est accessible et agréable pour déménager. Peu de contraintes.",
        "65+ déménagements suivis. Ville étudiante (40 000 étudiants, université, grandes écoles). Déménagements fluides.",
      ],
    },
    {
      id: "prix-angers",
      ...
      content: [
        "<strong>Studio</strong> : 340-560€<br/><strong>T2</strong> : 580-890€<br/><strong>T3</strong> : 890-1330€<br/><strong>T4+</strong> : 1330-2000€",
        "Prix compétitifs, similaires à Dijon, Reims. Très abordables.",
      ],
    },
  ],
  neighborhoods: [
...
export const NIMES_PREMIUM_GUIDE: PremiumCityGuideData = {
  ...
  sections: [
    {
      id: "nimes-sud",
      title: "Nîmes : Sud accessible avec patrimoine romain",
      content: [
        "Nîmes, c'est la Rome française. Arènes (20 000 places), Maison Carrée, patrimoine exceptionnel. Et pourtant, déménager à Nîmes est plutôt simple.",
        "55+ déménagements suivis. Centre historique demande attention (rues autour arènes), mais quartiers modernes très accessibles.",
        "Attention aux Férias (Pentecôte mai + septembre) : ville en fête, circulation bloquée.",
      ],
    },
    {
      id: "prix-nimes",
      ...
      content: [
        "<strong>Studio</strong> : 350-570€<br/><strong>T2</strong> : 600-920€<br/><strong>T3</strong> : 920-1380€<br/><strong>T4+</strong> : 1380-2100€",
        "Prix Sud, similaires à Montpellier. Centre : +80-120€. Féria : évitez (ville bloquée).",
      ],
    },
  ],
  neighborhoods: [
  ...
  sections: [
    {
      ...
      title: "Villeurbanne : Lyon sans les galères",
      content: [
        "Villeurbanne (150 000 habitants), c'est la ville jumelle de Lyon. Techniquement une commune séparée, mais concrètement : métropole lyonnaise, même tissu urbain.",
        "",
        "Différence majeure : Villeurbanne c'est plat, moderne, accessible. Pas de Croix-Rousse (pentes), pas de Vieux Lyon (ruelles). Résultat : déménagements 200-500€ moins chers que Lyon difficile.",
        "",
        "85+ déménagements suivis. Quartiers accessibles (Gratte-Ciel, Charpennes, Tonkin), immeubles avec ascenseurs, parkings disponibles.",
      ],
    },
    {
      id: "prix-villeurbanne",
      title: "Prix Villeurbanne 2026",
      content: [
        "<strong>Studio</strong> : 370-600€<br/><strong>T2</strong> : 630-970€<br/><strong>T3</strong> : 970-1450€<br/><strong>T4+</strong> : 1450-2200€",
        "Prix similaires à Lyon Part-Dieu, mais 200-500€ moins chers que Lyon Croix-Rousse/Vieux Lyon.",
      ],
    },
  ],
  neighborhoods: [
...
export const LE_HAVRE_PREMIUM_GUIDE: PremiumCityGuideData = {
  ...
  sections: [
    {
      id: "le-havre-perret",
      title: "Le Havre : urbanisme Perret = déménagement facile",
      content: [
        "Le Havre a une particularité unique : entièrement reconstruite après les bombardements de 1944 par l'architecte Auguste Perret. Résultat : ville moderne, larges avenues perpendiculaires, immeubles standardisés avec ascenseurs.",
        "",
        "50+ déménagements suivis. C'est une des villes les plus faciles de France pour déménager. L'urbanisme Perret (classé UNESCO) = praticité maximale.",
        "",
        "Seule contrainte : le port (circulation camions). Mais hors zone portuaire, c'est ultra-fluide.",
      ],
    },
    {
      id: "prix-le-havre",
      title: "Prix Le Havre 2026",
      content: [
        "<strong>Studio</strong> : 340-560€<br/><strong>T2</strong> : 580-890€<br/><strong>T3</strong> : 890-1330€<br/><strong>T4+</strong> : 1330-2000€",
        "Prix Normandie, très compétitifs. Parmi les moins chers de France.",
      ],
    },
  ],
  neighborhoods: [
