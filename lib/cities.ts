...
const CORE_CITIES: CityInfo[] = [
  {
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Nice',
  ...
  },
  {
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Lyon',
  ...
  },
  {
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Marseille',
    region: 'Provence-Alpes-Côte d\'Azur',
  },
  {
    slug: 'toulouse',
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Toulouse',
    region: 'Occitanie',
  },
  {
    slug: 'bordeaux',
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Bordeaux',
  ...
  },
  {
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Lille',
  ...
  },
  {
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Strasbourg',
    region: 'Grand Est',
  },
  {
    slug: 'nantes',
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Nantes',
  ...
  },
  {
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Rennes',
    region: 'Bretagne',
  },
  {
    slug: 'rouen',
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Rouen',
    region: 'Normandie',
  },
  {
    slug: 'montpellier',
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Montpellier',
    region: 'Occitanie',
  },
  // Nouveaux sites qui seront progressivement redirigés vers moverz.fr
  {
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Paris',
  ...
  },
  {
    ...
    description: 'Comparez 3 à 5 devis de déménageurs en Île-de-France',
    region: 'Île-de-France',
  },
  {
    slug: 'grenoble',
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Grenoble',
    region: 'Auvergne-Rhône-Alpes',
  },
  {
    slug: 'toulon',
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Toulon',
    region: 'Provence-Alpes-Côte d\'Azur',
  },
  {
    slug: 'dijon',
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Dijon',
  ...
  },
  {
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Angers',
    region: 'Pays de la Loire',
  },
  {
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Clermont-Ferrand',
    region: 'Auvergne-Rhône-Alpes',
  },
  {
    slug: 'tours',
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Tours',
  ...
  },
  {
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Reims',
    region: 'Grand Est',
  },
  {
    slug: 'le-havre',
    ...
    description: 'Comparez 3 à 5 devis de déménageurs au Havre',
    region: 'Normandie',
  },
  {
    slug: 'saint-etienne',
    ...
    description: 'Comparez 3 à 5 devis de déménageurs à Saint-Étienne',
    region: 'Auvergne-Rhône-Alpes',
  },
];
...
function buildExtraCities(): CityInfo[] {
  return EXTRA_CITIES.map(({ nameCapitalized, region }) => {
    ...
    return {
      ...
      nameCapitalized,
      url: "https://moverz.fr",
      description: `Comparez 3 à 5 devis de déménageurs à ${nameCapitalized}`,
      region,
    };
  });
}
